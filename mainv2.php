<?php 
	...
	require_once 'cOnfig/view-noclick.php';
...
EOD;
	...
	if ($_SESSION['puestosOrNot'] == 1) {
		...
		if (isset($_SESSION['workstation'])) {
			...
			pageStart("CCS", NULL, $testinput, "pmain", "notSelected", $lang['choose-workstation'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<center>
 <span class="ctalinks">
 <div class='fcta'><span id="dispenseCTA"></span><br /><?php echo $lang['index-dispense']; ?></div>
 <div class='fcta'><span id="productsCTA"></span><br /><?php echo $lang['index-menu']; ?></div>
 <div class='fcta'><span id="barCTA"></span><br /><?php echo $lang['barC']; ?></div><br />
 <div class='fcta'><span id="profileCTA"></span><br /><?php echo $lang['member-profilecaps']; ?></div>
 <div class='fcta'><span id="membersCTA"></span><br /><?php echo $lang['index-membersC']; ?></div>
 <div class='fcta'><span id="newmemberCTA"></span><br /><?php echo $lang['index-newmember']; ?></div>
 </span>
</center>
