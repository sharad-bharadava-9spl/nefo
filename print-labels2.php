...
EOD;
	...
	pageStart($lang['print-barcodes'], NULL, NULL, "ppurchases", "purchases admin dev-align-center", $lang['print-barcodes'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
$i = 0;
	...
	$purchase_row =	sprintf("
  	  <tr>
  	   ...
  	   <td>%s</td>
  	   <td>
  	    <input type='number' name='toPrint[%d][noOfCodes]' class='twoDigit defaultinput' value='1' />
...
<button type="submit" class='cta1'>Submit</button>
</form>
