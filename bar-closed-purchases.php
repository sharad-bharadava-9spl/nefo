...
EOD;
	...
	echo "<center><a href='bar-open-purchases.php' class='cta1'>{$lang['open-purchases']}</a>";
	echo "<a href='bar-new-purchase.php' class='cta1'>{$lang['newpurchase']}</a>";
?>
<br><img src="images/excel-new.png" ID="xllink" onClick="loadExcel();" style="cursor: pointer;" value="Export to Excel" />
...
<script type="text/javascript">
	 function loadExcel(){
 			$("#load").show();
       		window.location.href = 'bar-closed-purchases-report.php';
       		    setTimeout(function () {
			        $("#load").hide();
			    }, 5000);   
       }
