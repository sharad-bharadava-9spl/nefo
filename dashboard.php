	 ...
	 <table class="default" id="mainTable">
	  ...
	  <tbody>
	   <tr>
	    ...
	    <td class='right'>0 <?php echo $_SESSION['currencyoperator'] ?></td>
	    <td class='left'></td>
	    <td class='left'></td>
	   </tr>
	   <tr>
	    ...
	    <td class='right'>7.166 <?php echo $_SESSION['currencyoperator'] ?></td>
	   ...
	   <tr>
	    ...
	    <td class='right'>11.884 <?php echo $_SESSION['currencyoperator'] ?></td>
	    <td class='left'></td>
	    <td class='left'></td>
	   </tr>
	   <tr>
	    ...
	    <td class='right'>14.226 <?php echo $_SESSION['currencyoperator'] ?></td>
	    <td class='center negative'>Yes</td>
