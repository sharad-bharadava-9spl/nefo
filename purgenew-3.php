 ...
 <tr>
  ...
  <td>Movimientos de producto<a href="uTil/excel-exp.php?exp=log">&nbsp;&nbsp;<img src="images/excel.png" width="15" /></a></td>
		...
		?>
		 ...
		 <input type="text" id="datepicker2" name="untilDate" autocomplete="nope" class="sixDigit defaultinput" placeholder="<?php echo $lang['choosedate']; ?>" /><br /><br />
		 <span class='smallgreen'>Importe diario:</span>
		 Desde: <input type="number" name="fromAmount" class="sixDigit defaultinput" value="" /><br /><br />
		 Hasta: <input type="number" name="toAmount" class="sixDigit defaultinput" value="" /><br /><br />
