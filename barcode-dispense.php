<?php 
	...
	echo "<center><div class='actionbox-np2'><div class='boxcontent'><img src='{$google_root}images/_$domain/members/$user_id.$photoExt' class='salesPagePic' style='max-width: 200px; max-height: 200px;'/><h5>#$memberno - $first_name $last_name</h5><div class='clearfloat'></div><span class='creditDisplay'>{$lang['global-credit']}: <span class='creditAmount'>" . number_format($credit,2) . "</span></span></div></div></center><br />";
...
<center>
 <form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="" autocomplete="off" method="POST">
  <input type="text" class='defaultinput' name="barcode" id="focus" maxlength="80" autofocus placeholder="Codigo de barra" /><br />
