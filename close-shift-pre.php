<?php
	...
	if ($_SESSION['openAndClose'] < 4) {
		...
		pageStart($lang['close-shift'], NULL, $confirmLeave, "pcloseday", "dev-align-center", $lang['close-shift'] . " - ERROR", $_SESSION['successMessage'], $_SESSION['errorMessage']);
		exit();
	...
	if ($rowCount == 0) {
		...
		if ($firstDayOpen < 2) {
			...
			$_SESSION['openingid'] = $row['openingid'];
			$_SESSION['openingtime'] = $row['openingtime'];
			$_SESSION['tillBalance'] = $row['tillBalance'];
