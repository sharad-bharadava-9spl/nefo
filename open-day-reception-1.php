<?php
	...
	if ($_SESSION['noCompare'] != 'true') {
		...
		$closingLookup = "SELECT oneCent, twoCent, fiveCent, tenCent, twentyCent, fiftyCent, oneEuro, twoEuro, fiveEuro, tenEuro, twentyEuro, fiftyEuro, hundredEuro, coinsTot, notesTot, cashintill, bankBalance FROM closing ORDER BY closingtime DESC LIMIT 1";
...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step1 dev-align-center", $lang['openday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

	
?>
		
	<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="open-day-reception-2.php" method="POST"><br />
		<div class="actionbox-np2">
			 <div class="boxcontent">	
				 <table class="purchasetable">
				  <tr>
				   <td><?php echo $lang['tillyesterday']; ?>
				   	<input type="number" lang="nb" name="cashintillYday" id="cashintillYday" class="fourDigit purchaseNumber" value="<?php echo $cashintillYday; ?>" readonly /></td>
				  </tr>
				  <tr>
				   <td><?php echo $lang['tillnow']; ?>
				   	<strong><input type="number" lang="nb" name="tillTot" id="tillTot" class="fourDigit purchaseNumber" value="<?php echo $tillTot; ?>" readonly /></strong></td>
				  </tr>
				 </table>
			</div>
		</div>
		 ...
		 <input type='hidden' name='step2' value='complete' /><br />
 		 <button name='oneClick' class='cta1' type="submit"><?php echo $lang['global-confirm']; ?></button>
 	</form>
...
EOD;
			...
			pageStart($lang['title-openday'], NULL, $testinput, "pcloseday", "step2 dev-align-center", $lang['opendayone'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<form id="registerForm" action="" method="POST" onsubmit="return checkMismatch()"><br />
	<div class="actionbox-np2">
		<div class="mainboxheader"><?php echo $lang['tillmismatch']; ?></div><br>
		  <div class="boxcontent">
			 ...
			 <input type="number" lang="nb" name="oneCentYday" id="oneCentYday" class="fourDigit defaultinput" value="<?php echo $oneCentYday; ?>" readonly />
			 <input type="number" lang="nb" name="twoCentYday" id="twoCentYday" class="fourDigit defaultinput" value="<?php echo $twoCentYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="fiveCentYday" id="fiveCentYday" class="fourDigit defaultinput" value="<?php echo $fiveCentYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="tenCentYday" id="tenCentYday" class="fourDigit defaultinput" value="<?php echo $tenCentYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="twentyCentYday" id="twentyCentYday" class="fourDigit defaultinput" value="<?php echo $twentyCentYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="fiftyCentYday" id="fiftyCentYday" class="fourDigit defaultinput" value="<?php echo $fiftyCentYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="oneEuroYday" id="oneEuroYday" class="fourDigit defaultinput" value="<?php echo $oneEuroYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="twoEuroYday" id="twoEuroYday" class="fourDigit defaultinput" value="<?php echo $twoEuroYday; ?>" readonly />
			 <strong><input type="number" lang="nb" name="coinsTotYday" id="coinsTotYday" class="fourDigit defaultinput" value="<?php echo $coinsTotYday; ?>" readonly /></strong><br />
			 ...
			 <input type="number" lang="nb" name="fiveEuroYday" id="fiveEuroYday" class="fourDigit defaultinput" value="<?php echo $fiveEuroYday; ?>" readonly />
			 <input type="number" lang="nb" name="tenEuroYday" id="tenEuroYday" class="fourDigit defaultinput" value="<?php echo $tenEuroYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="twentyEuroYday" id="twentyEuroYday" class="fourDigit defaultinput" value="<?php echo $twentyEuroYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="fiftyEuroYday" id="fiftyEuroYday" class="fourDigit defaultinput" value="<?php echo $fiftyEuroYday; ?>" readonly /> 
			 <input type="number" lang="nb" name="hundredEuroYday" id="hundredEuroYday" class="fourDigit defaultinput" value="<?php echo $hundredEuroYday; ?>" readonly />
			 <strong><input type="number" lang="nb" name="notesTotYday" id="notesTotYday" class="fourDigit defaultinput" value="<?php echo $notesTotYday; ?>" readonly /></strong><br />
			 <span class="smallgreen short"><?php echo $lang['dispensary-today']; ?>:</span>
			 ...
			 <center>
			 <span class='usergrouptext2'><?php echo $lang['closeday-tillcomment']; ?>:</span><br />
			 <textarea class='defaultinput' name='tillComment' id="tillComment"></textarea>
			 <br />
			 <input type="hidden" name="tillConfirm" value="yes" />
	 		
 		</div>
 	</div>
 	 <button name='oneClick' class='cta1' type="submit"><?php echo $lang['confirmtillbal']; ?></button>
</form>
