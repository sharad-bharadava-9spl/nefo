<?php 
	...
	if ($_SESSION['showOrigPrice'] == 1) {
		...
		$normalPrice = "({$flower['salesPrice2']} &euro;)";
   ...
   function compute2() {
	...
	<div class='displaybox'>
	 ...
	 <center>
  	  ...
  	  <input type='text' lang='nb' class='fourDigit centered calc2 onScreenKeypad tst' id='eurcalc%d' name='sales[%d][euro]' placeholder='&euro;' step='0.01' value='%s' />
