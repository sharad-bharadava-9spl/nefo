...
<center><a href="bar-new-provider.php" class="cta1"><?php echo $lang['new-provider']; ?></a></center>
	...
	$flower_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow right' href='bar-provider.php?providerid=%d'>%0.02f &euro;</td>
	   <td class='relative'><span class='relativeitem'>$commentRead</span></td>
  	   <td style='text-align: center;'><a href='javascript:delete_provider(%d)'><img src='images/delete.png' height='15' title='Delete provider' /></a></td>
	  </tr>",
