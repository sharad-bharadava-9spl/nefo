...
exit();
	 ...
	 */	
		...
		pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "", $lang['title-openday'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
?>

<a href="?manual" class="cta"><?php echo $lang['count-and-weigh']; ?></a>
<a href="?autoopening" class="cta"><?php echo $lang['use-yday-values']; ?></a>
