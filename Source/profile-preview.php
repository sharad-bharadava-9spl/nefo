...
<?php
	...
	if ($usageType == 1) {
		$usageType = $lang['member-medicinal'];
	} else {
		$usageType = $lang['member-recreational'];
	}
	
	echo $groupName . " - " . $usageType; ?></span><br />
...
<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="" method="POST">
 ...
 <input type="text" name="cardid" maxlength="30" autofocus placeholder="<?php echo $lang['global-scantoconfirm']; ?>" /><br />
