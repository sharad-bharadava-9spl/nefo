   ...
   function compute2() {
	   ...
	   <tr>
	    ...
	    <td><input type='number' lang='nb' class='fourDigit centered calc3' style='border: #5aa242 solid 2px; width: 50px; border-radius: 2px; padding: 2px 1px;' id='grcalc%d' name='sales[%d][grams]' value='$unit' readonly /></td>
  	    <td><input type='number' lang='nb' class='fourDigit centered calc2' id='eurcalc%d' name='sales[%d][euro]' placeholder='&euro;' step='0.01' value='$price' style='//display: none;' /></td>
...
<?php
echo "<a href='new-picture.php?user_id=$user_id'><img src='images/members/$user_id.$photoExt' class='userPicture' /></a><span class='memberinfo'><a href='#' id='chipClick'><img src='images/rfid.png' /></a>&nbsp; $userStar <a href='profile.php?user_id=$user_id'><span class='membername'>$memberno $first_name $last_name</span></a>";
