	 ...
	 <table class='default' id='t1'>
	  ...
	  <tbody>
  	   <tr>
  	    ...
  	    <td class='right'><?php echo number_format($membershipFees,2); ?> €</td>
  	    <td class='right'><?php echo number_format($membershipfeesBank,2); ?> €</td>
  	    <td class='right'><strong><?php echo number_format($membershipFees + $membershipfeesBank,2); ?> €</strong></td>
  	   </tr>
  	   <tr>
  	    <td class='left'><?php echo $lang['global-donations']; ?></td>
  	    <td class='right'><?php echo number_format($donations,2); ?> €</td>
  	    <td class='right'><?php echo number_format($bankDonations,2); ?> €</td>
  	    <td class='right'><strong><?php echo number_format($donations + $bankDonations,2); ?> €</strong></td>
  	   </tr>
<?php if ($_SESSION['creditOrDirect'] == 0) { ?>
  	   <tr>
  	    <td class='left'><?php echo $lang['direct-dispenses']; ?></td>
  	    <td class='right'><?php echo number_format($salesTodayCash,2); ?> €</td>
  	    <td class='right'><?php echo number_format($salesTodayBank,2); ?> €</td>
  	    <td class='right'><strong><?php echo number_format($salesTodayCash + $salesTodayBank,2); ?> €</strong></td>
  	   </tr>
  	   <tr>
  	    <td class='left'><?php echo $lang['direct-bar-sales']; ?></td>
  	    <td class='right'><?php echo number_format($salesTodayBarCash,2); ?> €</td>
  	    <td class='right'><?php echo number_format($salesTodayBarBank,2); ?> €</td>
  	    <td class='right'><strong><?php echo number_format($salesTodayBarCash + $salesTodayBarBank,2); ?> €</strong></td>
  	   </tr>
<?php } ?>
  	   <tr>
  	    <td class='left'><strong>Total</strong></td>
  	    <td class='right'><strong><?php echo number_format($membershipFees + $donations + $salesTodayCash + $salesTodayBarCash,2); ?> €</strong></td>
  	    <td class='right'><strong><?php echo number_format($membershipfeesBank + $bankDonations + $salesTodayBank + $salesTodayBarBank,2); ?> €</strong></td>
  	    <td class='right'><strong><?php echo number_format($membershipfeesBank + $bankDonations + $membershipFees + $donations + $salesTodayCash + $salesTodayBarCash + $salesTodayBank + $salesTodayBarBank,2); ?> €</strong></td>
  	   </tr>
	  </tbody>
	 </table>
