<?php
	...
	// check DNI
	$file1 = "images/_dabulance/ID/" . $user_id . "-front.$dniext1";
	
	// check signature
	$file2 = "images/_dabulance/sigs/" . $user_id . ".$sigext";
...
<input type="hidden" name="submit" value="true" />
  <table>
   ...
   <tr>
    ...
    <td><textarea id="comment" /><?php echo $adminComment; ?></textarea><br />&nbsp;</td>
   </tr>
