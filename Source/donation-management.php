...
EOD;
	...
	echo "<br /><br /><span class='creditDisplay'>Credit: <span class='creditAmount $userClass'>" . number_format($credit,2) . " &euro;$creditEligibility";
	
    if ($_SESSION['saldoGift'] == 1) {
	    echo "&nbsp;<a href='gift-credit.php' style='display: inline-block; margin-top: -3px;'><img src='images/free2.png' /></a>";
    }
