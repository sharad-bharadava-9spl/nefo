...
<h1>SOLICITUD DE INSCRIPCIÓN / DECLARACIÓN JURADA</h1>
...
<ul class="normallist">
 ...
 <li>Como consumidor habitual de cannabis indicar que el consumo semanal que la asociación aportará a este socio será de <input type="text" name="consumoPrevio" class="twoDigit" /> gramos de cannabis, acorde la misma en la cuantía estimada por la jurisprudencia de autoconsumo, de 3 a 5 gramos diarios. Este aporte de Cannabis no podrá ser extraído del local de la asociación en ningún caso y tras proporcionárselo el socio deberá permanecer en el local una estancia mínima de veinte minutos<br />&nbsp;</li>
