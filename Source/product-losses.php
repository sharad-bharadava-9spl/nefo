	...
	if ($onesale['category'] == 1) {
		...
		$row = $result->fetch();
			...
			if (($normalPrice - $onesale['amount']) > 0.05) {
				...
				$detailedLosses .= number_format($normalPrice,2) . " <span class='smallerfont'>&euro;</span><br />";
				$fullNormalPrice = $fullNormalPrice + $normalPrice;
				
			} else {
				
				$detailedLosses .= number_format($onesale['amount'],2) . " <span class='smallerfont'>&euro;</span><br />";
		...
		$loss = number_format($fullPrice - $amount,2);
				...
				$detailedLosses .= "
				<td class='clickableRow right' href='dispense.php?saleid={$saleidOne}'><strong>{$fullNormalPrice} &euro;</strong></td>
				<td class='clickableRow right' href='dispense.php?saleid={$saleidOne}'><strong>{$fullPaidPrice} &euro;</strong></td>
				<td class='clickableRow right' href='dispense.php?saleid={$saleidOne}'><strong>{$fullLoss} &euro;</strong></td>
				";	
...
<br /><table style='color: #444; text-align: right; font-family: Tahoma, Verdana, sans-serif; font-size: 14px;' id='t1'>
 <tr>
  ...
  <td class='right'>{$expr(number_format($reducedLost,2))} €</td>
 </tr>
 <tr>
  <td class='left' style='border-bottom: 1px dashed #ababab;'>Perdidos sobre regalados</td>
  <td class='right' style='border-bottom: 1px dashed #ababab;'>{$expr(number_format($giftedLost,2))} €</td>
 </tr>
 <tr>
  <td class='left' style='border-bottom: 1px solid #ababab;'><strong>Perdido en total</strong></td>
  <td class='right' style='border-bottom: 1px solid #ababab;'><strong>{$expr(number_format($reducedLost + $giftedLost,2))} €</strong></td>
 </tr>
</table>
EOD;
