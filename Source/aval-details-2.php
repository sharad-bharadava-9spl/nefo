...
$totalAmountPerWeek = number_format($totalAmountPerWeek,0);
	...
	if (!file_exists($topimg)) {
		$topimg = 'images/silhouette-new-big.png';
	}
...
EOD;
			...
			<tr>
			 ...
			 <td>$groupName</td>
			 <td class='relative centered'><span style='position: relative;'>$commentRead</span></td>
...
if ($_GET['chain'] != 'true') {
  ...
  <center><a href='aval-check-2.php?aval=$origAval' class='fakebutton'>{$lang['continue']}</a></center><br />";
	...
	echo "
  <div class='clearfloat'></div>
  <center><a href='new-member-new.php?aval2=$origAval' class='fakebutton'>{$lang['continue']}</a></center><br />";
