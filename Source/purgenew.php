	 ...
	 <table class='default' id='t1'>
	  ...
	  <tbody>
  	   <tr>
  	    ...
  	    <td class='right' style='background-color: #ddd;'><?php echo number_format($membershipfeesBank,2); ?> €</td>
  	    <td class='right'><?php echo number_format($membershipFees,2); ?> €</td>
  	    <td class='right'><?php echo number_format($membershipFees / $noOfDays,2); ?> €</td>
  	   </tr>
  	   <tr>
  	    <td class='left'>Aportaciones</td>
  	    <td class='right' style='background-color: #ddd;'><?php echo number_format($bankDonations,2); ?> €</td>
  	    <td class='right'><?php echo number_format($donations,2); ?> €</td>
  	    <td class='right'><?php echo number_format($donations / $noOfDays,2); ?> €</td>
  	   </tr>
  	   <tr>
  	    <td class='left'><strong>Total</strong></td>
  	    <td class='right' style='background-color: #ddd;'><strong><?php echo number_format($membershipfeesBank + $bankDonations,2); ?> €<input type='hidden' name='bankTot' id='bankTot' value="<?php echo $membershipfeesBank + $bankDonations; ?>" /></strong></td>
  	    <td class='right'><strong><?php echo number_format($membershipFees + $donations,2); ?> €<input type='hidden' name='cashTot' id='cashTot' value="<?php echo $membershipFees + $donations; ?>" /><input type='hidden' name='totDays' id='totDays' value="<?php echo $noOfDays; ?>" /></strong></td>
  	    <td class='right'><strong><?php echo number_format(($membershipFees + $donations)/ $noOfDays,2); ?> €</strong></td>
