...
EOD;
	...
	pageStart("Visitas", NULL, $deleteDonationScript, "pdispensary", "product admin", "Visitas", $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
?>

<center><img src="images/excel.png" style="cursor: pointer;" onclick="tablesToExcel(['t1', 't2', 't3', 't4', 't5', 't6', 't7', 't8', 't9'], ['t1', 't2', 't3', 't4', 't5', 't6', 't7', 't8', 't9'], 'myfile.xls')" value="Export to Excel" /></center>
...
<table class="dayByDay displaybox" id="t1">
 <tr>
...
<table class="dayByDay displaybox adminHidden" id="t2">
 <tr>
...
<table class="dayByDay displaybox adminHidden" id="t3">
 <tr>
