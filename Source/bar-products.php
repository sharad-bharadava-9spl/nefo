...
EOD;
	...
	$product_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow' href='bar-edit-product.php?productid=$productid' style='text-align: center;'><a href='bar-edit-product.php?productid=%d'><img src='images/edit.png' height='15' title='Editar' /></a>&nbsp;&nbsp;<a href='javascript:delete_service(%d, %d)'><img src='images/delete.png' height='15' title='Delete' /></a></td>
	  </tr>",
