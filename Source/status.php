...
<table class='defaultalternate'>
 <tr>
  ...
  <td><strong>{$expr(number_format($salesToday,2))} &euro;</strong></td>
  <td></td>
...
EOD;
 ...
 <tr>
  <td style='text-align: left;'><em>{$lang['closeday-ow']} $name</em></td>
  <td>{$expr(number_format($barsalesTodayOthers,2))} &euro;</td>
...
<table class='defaultalternate'>
 <tr>
  ...
  <td><strong>{$expr(number_format($barSales,2))} &euro;</strong></td>
  <td></td>
  <td></td>
  <td></td>
  <td></td>
...
<table style='color: #444; text-align: right; font-family: Tahoma, Verdana, sans-serif; font-size: 14px;'>
 ...
 <tr>
  <td style='text-align: left;'><strong>{$lang['dispensary']}</strong></td>
  <td><strong>{$expr(number_format($salesToday,2))} &euro;</strong></td>
  <td></td>
  <td><strong>{$expr(number_format($quantitySold,2))} g.</strong></td>
  <td></td>
