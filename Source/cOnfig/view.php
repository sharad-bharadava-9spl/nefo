...
/******* HEREDOC FUNCTIONS ********/
	...
	function displayHead($pageTitle = "", $meta = NULL, $embeddedJS = NULL) {
		...
		if ($domain == 'tresor') {
			...
			$cssfile = "<link rel='stylesheet' href='{$siteroot}css/stylesv5.css' type='text/css' />";
		}
...
EOD;
	...
	if (isset($_SESSION['user_id'])) {
		...
		if ($_SESSION['lang'] == 'es') {
			...
			$langswitch = "<img src='{$siteroot}images/es.png' id='langselect' />";
			...
			$langswitch = "<img src='{$siteroot}images/ca.png' id='langselect' />";
			...
			$langswitch = "<img src='{$siteroot}images/it.png' id='langselect' />";
			...
			$langswitch = "<img src='{$siteroot}images/nl.png' id='langselect' />";
			...
			$langswitch = "<img src='{$siteroot}images/fr.png' id='langselect' />";
			...
			$langswitch = "<img src='{$siteroot}images/gb.png' id='langselect' />";
				...
				if ($_SESSION['user_id'] != 999999) {
					...
					if ($_SESSION['lang'] == 'es') {
						...
						$invoices
							...
							echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Accés deshabilitat causa de factura (s) pendent (s). <br /> Contacta'ns en <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> facturacion@cannabisclub.systems </a> o telèfon +34 644.441.092 per recuperar el vostre accés. <br /> <br />";
						if ($_SESSION['userGroup'] == 1 && $_SESSION['domain'] != 'highclassbcn') {
							
							echo "
						Factures pendents - punxa per veure:<br />
						$invoices
						</div></div></center>";
						
						}
					} else if ($_SESSION['lang'] == 'fr') {
						echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Accès désactivé en raison de factures en attente. <br /> Contactez-nous à l'adresse <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> invoice@cannabisclub.systems </a> ou appelez le +34 644 441 092 pour récupérer votre accès. <br /> <br />";
						if ($_SESSION['userGroup'] == 1 && $_SESSION['domain'] != 'highclassbcn') {
							
							echo "
						Factures en attente - cliquez pour voir:<br />
						$invoices
						</div></div></center>";
						
						}
					} else if ($_SESSION['lang'] == 'it') {
						echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Accesso disabilitato a causa di fatture in sospeso. <br /> Contattaci a <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> invoice@cannabisclub.systems </a> o telefona al numero +34 644 441 092 per recuperare l'accesso. <br /> <br />";
						if ($_SESSION['userGroup'] == 1 && $_SESSION['domain'] != 'highclassbcn') {
							
							echo "
						Fatture in sospeso: fare clic per visualizzare:<br />
						$invoices
						</div></div></center>";
						
						}
					} else if ($_SESSION['lang'] == 'nl') {
						echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Toegang uitgeschakeld vanwege openstaande facturen. <br /> Neem contact met ons op via <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> factuur@cannabisclub.systems </a> of telefoon +34 644 441 092 om uw toegang te herstellen. <br /> <br />";
			
						if ($_SESSION['userGroup'] == 1 && $_SESSION['domain'] != 'highclassbcn') {
							
							echo "
						Facturen in behandeling - klik om te zien:<br />
						$invoices
						</div></div></center>";
				...
				if ($_SESSION['domain'] == 'choko' || $_SESSION['domain'] == 'bettyboop' || $_SESSION['domain'] == 'cloud' || $_SESSION['domain'] == 'relax' || $_SESSION['domain'] == 'manali' || $_SESSION['domain'] == 'terpsarmy' || $_SESSION['domain'] == 'personal') {
					...
					if ($_SESSION['userGroup'] == 1) {
						...
						if ($_SESSION['lang'] == 'es') {
							...
							echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> <span style = 'font-size: 26px; color: yellow; '> ***** Últim avís! ***** </span> <br /> <br /> Té factura (s) pendent (s) del pagament. Si no rebem justificant de pagament avui, perdràs accés al programa! <br /> Per a qualsevol dubte, contacteu-a <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> facturacion@cannabisclub.systems </a> o telèfon +34 644.441.092. </div> </div> </center>";							
						} else if ($_SESSION['lang'] == 'fr') {
							echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> <span style = 'font-size: 26px; color: yellow; '> ***** Dernier avertissement! ***** </span> <br /> <br /> Vous avez une facture en attente de paiement. Si nous ne recevons pas de preuve de paiement aujourd'hui, vous perdrez l'accès au programme! <br /> Pour toute question, contactez-nous à l'adresse <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00! important;'> invoice@cannabisclub.systems </a> ou par téléphone au +34 644 441 092. </div> </div> </center>";							
						} else if ($_SESSION['lang'] == 'it') {
							echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> <span style = 'font-size: 26px; color: yellow; '> ***** Ultimo avviso! ***** </span> <br /> <br /> Hai una fattura in attesa di pagamento. Se non riceviamo la prova del pagamento oggi, perderai l'accesso al programma! <br /> Per qualsiasi domanda, contattaci all'indirizzo <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> invoice@cannabisclub.systems </a> o telefono +34 644 441 092. </div> </div> </center>";							
						} else if ($_SESSION['lang'] == 'nl') {
							echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> <span style = 'font-size: 26px; color: yellow; '> ***** Laatste waarschuwing! ***** </span> <br /> <br /> U heeft een factuur in afwachting van betaling. Als we vandaag geen betalingsbewijs ontvangen, verliest u de toegang tot het programma! <br /> Neem voor vragen contact met ons op via <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> factuur@cannabisclub.systems </a> of telefoon +34 644 441 092. </div> </div> </center>";							
						} else {
							echo "<div id='main'><center><div id='scriptMsg'><div style='color: red;' class='error'><span style='font-size: 26px; color: yellow;'>***** Last warning! *****</span><br /><br />You have (an) unpaid invoice(s). If we do not receive proof of payment today, you will lose your system access!<br />If you have any doubts or questions, contact us on <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'>facturacion@cannabisclub.systems</a> or telephone +34 644 441 092.</div></div></center>";
						}
					...
					if ($_SESSION['userGroup'] == 1) {
						...
						if (isset($_GET['seenWarning'])) {
							...
							if ($_SESSION['lang'] == 'es') {
								...
								echo "<div id='main'> <center> <div id='scriptMsg'> <div style = 'color: xarxa;' class = 'error'> Té factura (s) pendent (s) del pagament. Per evitar la desactivació del seu servei, faci el pagament immediatament. <br /> L'accés al sistema es desactivarà l'<span style = 'color: # ffff00! Important;'> dia 2019.10.03 </span>! <br /> <br /> <span style = 'color: xarxa! important;'> IMPORTANT: </span> Ara pot comprovar que factures són pendents en el seu <a href = 'invoices.php' style = 'color: #ffff00! important;'> pantalla Factures </a>. <br /> <br /> Per a qualsevol dubte, contacteu-a <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> facturacion@cannabisclub.systems </a> <br /> <br /> <a href='?seenWarning' class='yellow'> Tancar alerta </a> </div> </div> </center>";
							} else if ($_SESSION['lang'] == 'fr') {
								echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Vous avez une facture en attente de paiement. Pour éviter de désactiver votre service, effectuez le paiement immédiatement. <br /> L’accès au système sera désactivé le <span style = 'color: # ffff00! Important;'> jour 04/11/2019 </span>! <br /> <br /> <span style = 'color: red! important;'> IMPORTANT: </span> Vous pouvez désormais vérifier quelles factures sont en attente dans votre <a href = 'invoices.php' style = 'color: #ffff00! important;'> écran Factures </a>. <br /> <br /> Pour toute question, contactez-nous à l'adresse <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> invoice@cannabisclub.systems </a> <br /> <br /> <a href='?seenWarning' class='yellow'> Fermer l'alerte </a> </div> </div> </center>";
							} else if ($_SESSION['lang'] == 'it') {
								echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> Hai una fattura in attesa di pagamento. Per evitare la disattivazione del servizio, effettua immediatamente il pagamento. <br /> L'accesso al sistema verrà disattivato su <span style = 'color: # ffff00! Importante;'> giorno 04/11/2019 </span>! <br /> <br /> <span style = 'color: red! important;'> IMPORTANTE: </span> Ora puoi controllare quali fatture sono in sospeso nel tuo <a href = 'invoices.php' style = 'color: #ffff00! important;'> Schermata Fatture </a>. <br /> <br /> Per qualsiasi domanda, contattaci all'indirizzo <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00 !important;'> invoice@cannabisclub.systems </a> <br /> <br /> <a href='?seenWarning' class='yellow'> Chiudi avviso </a> </div> </div> </center>";
							} else if ($_SESSION['lang'] == 'nl') {
								echo "<div id='main'> <center> <div id='scriptMsg'> <div style='color: red;' class='error'> U heeft een factuur in afwachting van betaling. Voer de betaling onmiddellijk uit om te voorkomen dat uw service wordt gedeactiveerd. <br /> Toegang tot het systeem wordt gedeactiveerd op <span style = 'color: # ffff00! Belangrijk;'> dag 04/11/2019 </span>! <br /> <br /> <span style = 'color: red! important;'> BELANGRIJK: </span> Nu kunt u controleren welke facturen in behandeling zijn in uw <a href = 'invoices.php' style = 'color: #ffff00! important;'> Factuurscherm </a>. <br /> <br /> Neem voor vragen contact met ons op via <a href='mailto:facturacion@cannabisclub.systems' style='color: #ffff00! belangrijk ;'> factuur@cannabisclub.systems </a> <br /> <br /> <a href='?seenWarning' class='yellow'> Waarschuwing sluiten </a> </div> </div> </center>";
							} else {
