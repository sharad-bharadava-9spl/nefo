...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step1", $lang['open-reception'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
?>
		...
		<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="open-reception-shift-2.php" method="POST"><br />
		 <table>
		  <tr>
		   <td><?php echo $lang['tillyesterday']; ?>:</td>
		...
		<form id="registerForm" action="" method="POST" onsubmit="return checkMismatch()"><br />
		 <table>
		  ...
		  <tr>
		   ...
		   <td><input type="number" lang="nb" name="tillTot" id="tillTot" class="fourDigit" value="<?php echo $tillTot; ?>" /></td>
		  </tr>
		 </table><br />
