...
EOD;
	...
	echo "<center><a href='bar-open-purchases.php' class='cta'>{$lang['open-purchases']}</a>";
...
<?php
	...
	$purchase_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.0f €</td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
	...
	$purchase_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.0f €</td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /u</span></td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /u</span></td>
  	   <td class='clickableRow right' href='bar-purchase.php?closed&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /u</span></td>
	   <td class='relative'>$barCodeImg</td>
	   <td class='relative'>%s</td>
