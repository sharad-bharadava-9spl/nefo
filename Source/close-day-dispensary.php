...
EOD;
	...
	pageStart($lang['title-closeday'], NULL, $confirmLeave, "pcloseday", "", $lang['closeday-dis-one'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<?php
  ...
  // AND NOW THE H TABLE:
	...
	$extract_row =	sprintf("
		<div class='productbox'>
	<h3>%s (%d)</h3><input type='number' lang='nb' name='daycloseProduct[%d][weight]' class='fourDigit' placeholder='g' step='0.01' value='0' disabled style='color: red;' required /><br />
  	   <input type='hidden' name='daycloseProduct[%d][name]' value='%s' />
	...
	$extract_row =	sprintf("
		<div class='productbox'>
	<h3>%s (%d)</h3><input type='number' lang='nb' name='daycloseProduct[%d][weight]' class='fourDigit' placeholder='g' step='0.01' required /><br />
  	   <input type='hidden' name='daycloseProduct[%d][name]' value='%s' />
  	   <input type='hidden' name='daycloseProduct[%d][category]' value='2' />
  	   <input type='hidden' name='daycloseProduct[%d][productid]' value='%d' />
  	   <input type='hidden' name='daycloseProduct[%d][purchaseid]' value='%d' />
...
<?php
  ...
  // AND NOW THE H TABLE:
	...
	$extract_row =	sprintf("
		<div class='productbox'>
	<h3>%s (%d)</h3><input type='number' lang='nb' name='daycloseProduct[%d][weight]' class='fourDigit prequired2' placeholder='g' step='0.01' id='required%d' required /><br />
  ...
  // AND NOW THE H TABLE:
	...
	$extract_row =	sprintf("
		<div class='productbox'>
	<h3>%s (%d)</h3><input type='number' lang='nb' name='daycloseProduct[%d][weight]' class='fourDigit prequired$category' placeholder='g' step='0.01' id='required%d' required /><br />
