<?php
	...
	if ($dayClosed == '1' && (!isset($_GET['redo']))) {
			...
			pageStart($lang['close-shift'], NULL, $validationScript, "pcloseday", "step2", $lang['close-shift'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
EOD;
		...
		pageStart($lang['close-shift'], NULL, $confirmLeave, "pcloseday", "step7", $lang['close-shift'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
EOD;
 ...
 <tr>
  <td colspan='11' style='color: #a80082; text-align: center; font-size: 14px; border-bottom: 1px solid #dedede;'><strong>{$lang['global-flowerscaps']} (g.)</strong></td>
 </tr>
 <tr>
  <td></td>
  <td><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></td>
...
EOD;
 ...
 <tr>
  <td colspan='11' style='color: #a80082; text-align: center; font-size: 14px; border-top: 1px solid #dedede; border-bottom: 1px solid #dedede;'><strong>{$lang['global-extractscaps']} (g.)</strong></td>
 </tr>
 <tr>
  <td></td>
  <td><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></td>
...
echo <<<EOD
<br /><a href='uTil/confirm-close-shift.php?oid={$_SESSION['openingid']}&cid=$closingid&closer={$_SESSION['user_id']}' class='cta' id='hidecta'>{$lang['close-shift']}</a><br />
