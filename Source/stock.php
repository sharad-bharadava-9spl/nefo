...
EOD;
		...
		<div class='displaybox'>
		 <a href='purchase.php?purchaseid=$purchaseid' target='_blank'><h3 style='margin-bottom: 2px;'>$name ($purchaseid)</h3></a>
		 ...
		 <span class='fakelabel'>- {$lang['gifted']}:</span><input type='number' lang='nb' name='confirmedClose[$x][soldToday]' id='soldToday' class='red fourDigit' value='$gifts' readonly /><br />
...
<h3 class='title'>{$lang['summarycaps']}</h3>
		...
		<div class='displaybox'>
		 ...
		 <span class='fakelabel'>- {$lang['gifted']}:</span><input type='number' lang='nb' name='confirmedClose[$x][soldToday]' id='soldToday' class='red fourDigit' value='$flowerTotGifts' readonly /><br />
		...
		<div class='displaybox'>
		 ...
		 <span class='fakelabel'>- {$lang['gifted']}:</span><input type='number' lang='nb' name='confirmedClose[$x][soldToday]' id='soldToday' class='red fourDigit' value='$extractTotGifts' readonly /><br />
