...
<p><input type="text" name="responsible" placeholder="Contact person" /> of legal age, with D.N I. (ID card) number <input type="text" name="dni" placeholder="DNI" /> and on behalf and in representation of  <input type="text" name="club" placeholder="Club name" />, hereinafter the "CLIENT", with registered address at  <input type="text" name="address" placeholder="Full address" />, <input type="text" name="cif" placeholder="CIF of club" />.</p>
