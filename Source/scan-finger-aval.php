...
function getREGID(ridval){
	...
	if(vidstart == 1){
	   ...
	   window.location = "aval-details.php?user_id="+empno+"&twoavals"; //MUITHI | STATUS IN/OUT NOT NEEDED | 29-JAN-2014 | 10-SEPT-2015 | 04-JULY-2016
	}
...
function getREGID(ridval){
	...
	if(vidstart == 1){
	   alert("SUCCESSFULY VERIFIED 1 !");
	   window.location = "aval-details.php?user_id="+empno; //MUITHI | STATUS IN/OUT NOT NEEDED | 29-JAN-2014 | 10-SEPT-2015 | 04-JULY-2016
	}
