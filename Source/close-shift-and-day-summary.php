...
echo <<<EOD
<br /><a href='uTil/confirm-close-shift-and-day.php?oid=$dayopeningid&cid=$dayclosingid&csid=$closingid&osid=$openingid&closer={$_SESSION['user_id']}' class='cta' id='hidecta'>{$lang['close-shift-and-day']}</a><br />
