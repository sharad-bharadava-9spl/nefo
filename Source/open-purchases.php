...
EOD;
	...
	echo "<center><a href='closed-purchases.php' class='cta1'>{$lang['closed-purchases']}</a>";
...
<?php echo "</center>";
	...
	$selectOpenPurchases = "SELECT purchaseid, category, productid, purchaseDate, purchasePrice, salesPrice, purchaseQuantity, realQuantity, adminComment, inMenu, barCode FROM purchases WHERE closedAt IS NULL AND category = 1 ORDER by purchaseDate DESC LIMIT 100";
		...
		echo "<h3 class='title' onClick='load1()' style='cursor: pointer;'><img src='images/icon-flower.png' height='30' style='margin-right: 10px; margin-bottom: -8px;' /> {$lang['global-flowerscaps']} (g.) <img src='images/expand.png' id='plus1' width='15' style='margin-left: 5px;' /><span id='spinner1'></span><input type='hidden' name='click1' id='click1' class='clickControl' value='0' /></h3><span id='menu1' style='display: none;'>";
...
<?php
	...
	$purchase_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.0f €</td>
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.2f<span class='smallerfont3'> &euro; /g</span></td>
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.0f g</td>
  	   <td class='clickableRow right' href='purchase.php?open&purchaseid=%d'>%0.0f g</td>
