<?php
	...
	pageStart("ID / " . $lang['member-passport'], NULL, NULL, "pprofile", "campage", $lang['member-newmembercaps'] . " - ID / " . $lang['member-passport'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<br />
 ...
 <div id='mainbox'>
  ...
  <?php echo $lang['member-newmembercaps'] . " - ID / Passport front"; ?>
  </div>
 ...
 <form action="new-member-1b.php" method="post" enctype="multipart/form-data">
...
<?php 
		echo "<form onsubmit='oneClick.disabled = true; return true;' id='myform' method='post' action='new-member-1b.php?newmember=true'>";
?>
