...
echo "<center><div id='profilearea'><h4>$first_name $last_name</h4><div class='clearfloat'></div>";
...
<form id="registerForm" action="" method="POST" onsubmit="return testInput()">
  ...
  <br />
  <textarea name='reason' placeholder='Reason for rejecting'></textarea><br /><br />
 <button type="submit">Reject member</button>
