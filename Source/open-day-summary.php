...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step5", $lang['openday-conf'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
?>
		 ...
		 <h3><?php echo $name . ' (' . $purchaseid . ')'; ?></h3>
		 <table>
		  <tr>
...
echo <<<EOD
<br /><a href='uTil/confirm-open-day.php?oid=$openingid&cid=$closingid&closer={$_SESSION['user_id']}' class='cta' id='hidecta'>{$lang['openday-main']}</a><br />
