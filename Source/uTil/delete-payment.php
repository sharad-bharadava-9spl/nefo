<?php
	...
	if ($_POST['confirmed'] == 'yes') {
		...
		$row = $result->fetch();
			...
			$query = sprintf("INSERT INTO log (logtype, logtime, user_id, operator, amount, oldExpiry, newExpiry, comment) VALUES ('%d', '%s', '%d', '%d', '%f', '%s', '%s', '%s');",
			3, $logTime, $userid, $_SESSION['user_id'], $amount, $newExpiry, $oldExpiry, $comment);
			...
			$query = sprintf("INSERT INTO f_log (logtype, logtime, user_id, operator, amount, oldExpiry, newExpiry, comment) VALUES ('%d', '%s', '%d', '%d', '%f', '%s', '%s', '%s');",
			3, $logTime, $userid, $_SESSION['user_id'], $amount, $newExpiry, $oldExpiry, $comment);
...
EOD;
	...
	pageStart($lang['delete-fee-payment'], NULL, $deleteDonationScript, "pprofilenew", "donations fees", $lang['delete-fee-payment'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
