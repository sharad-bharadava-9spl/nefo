...
<?php
	...
	echo sprintf("
  	  <tr>
  	   ...
  	   <td href='profile.php?user_id='><input type='text' name='newchip$user_id' placeholder='%s' /></td></tr>",
	...
	echo "</tbody></table><button type='submit' style='visibility: hidden;'>Submit</button></form>";
