...
<tbody>
 <tr>
  ...
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['global-total']}</td>
 </tr>
...
<tbody>
 <tr>
  ...
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['title-donations']}</td>
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['fees']}</td>
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['bar-sales-today']}</td>
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['direct-dispenses']}</td>
  <td class='centered' style='text-transform: uppercase; font-weight: 600;'>{$lang['global-total']}</td>
 </tr>
...
if ($_SESSION['creditOrDirect'] == 1) {
 ...
 <tr>
  ...
  <td>{$expr(number_format($donationsToday,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($feesToday,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($totalToday,2))} <span class="smallerfont">&euro;</span></td>
 </tr>
EOD;
 ...
 <tr>
  ...
  <td>{$expr(number_format($donationsToday,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($feesToday,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($salesTodayBarCash,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($salesTodayCash,2))} <span class="smallerfont">&euro;</span></td>
  <td>{$expr(number_format($totalToday,2))} <span class="smallerfont">&euro;</span></td>
 </tr>
EOD;
}
