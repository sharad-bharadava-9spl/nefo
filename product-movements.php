...
?>
<center><a href="#" onclick="loadExcel();" style='margin: 0 0 -5px 8px;'/><img src="images/excel-new.png"></a></center><br /><br />
<center>
	<div id="filterbox">
			...
			<?php
				if (isset($_POST['fromDate'])) {
					...
					echo <<<EOD
					 ...
					 <button type="submit" class="cta2" style='display: inline-block; width: 40px; height: 27px;'>OK</button>
			EOD;
...
<center><h3 class="title"><?php echo $lang['summary']; ?></h3></center>
	<table class='default'>
	  <thead>
	   <tr style='cursor: pointer;'>
	    <th><?php echo $lang['global-type']; ?></th>
	    <th><?php echo $lang['global-flower']; ?></th>
<?php if ($_SESSION['domain'] != 'weflowers') { ?>
...
?>
	 ...
	 <br />
	 <br />
	 <center><h3 class="title"><?php echo $lang['global-details']; ?></h3></center>
...
<script type="text/javascript">
	 function loadExcel(){
 			...
 			var fromDate = "<?php echo $_POST['fromDate'] ?>";
       		window.location.href = 'product-movements-report.php?filter='+filter+'&fromDate='+fromDate+'&untilDate='+untilDate;
       		    setTimeout(function () {
			        $("#load").hide();
			    }, 5000);   
       }
