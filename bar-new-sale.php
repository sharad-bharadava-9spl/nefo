<?php
	...
	if ($_SESSION['domain'] == 'dankgrass') {
		header("Location: bar-new-sale-2.php?user_id=1");
	}
...
EOD;
		...
		pageStart("BAR", NULL, $memberScript, "pmembership", NULL, "BAR", $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
?>		
	...
	if ($user['userGroup'] > 4 && $exento == 0) {
		...
		$user_row =	sprintf("
	  	  <tr>
	  	   <td class='clickableRow' href='bar-new-sale-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='bar-new-sale-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='bar-new-sale-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='bar-new-sale-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow centered' href='bar-new-sale-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='bar-new-sale-2.php?user_id=%d'>%s</td>
		  </tr>",
...
EOD;
		...
		pageStart("BAR", NULL, $memberScript, "psales", "dispensepre", "BAR", $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
?>
 ...
 <div id='mainbox'>
  ...
  <div class='twoboxessmall'>
   ...
   <form id="registerForm" action="bar-new-sale-2.php" method="POST">
