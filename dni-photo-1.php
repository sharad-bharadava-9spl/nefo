<?php
	...
	pageStart("DNI / " . $lang['member-passport'], NULL, NULL, "pprofile", 'dev-align-center', "DNI / " . $lang['member-passport'] . " - " . $lang['dni-front'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
?>
	...
	<!-- A button for taking snaps -->
		<div id="pre_take_buttons">
			<input type=button class="cta1" value="<?php echo $lang['member-takesnapshot']; ?>" onClick="preview_snapshot()"><br /><br />
		...
		<div id="post_take_buttons" style="display:none">
			...
			<input type=button value="<?php echo $lang['member-savephoto']; ?> &gt;"  class="cta1" onClick="save_photo()" style="font-weight:bold;"><br /><br />
			<a class="skipbutton" href="new-member-2.php?skipDNI" style='margin: 0; margin-left: 3px; width: 162px;'><?php echo $lang['skip']; ?></a>
		</div>
