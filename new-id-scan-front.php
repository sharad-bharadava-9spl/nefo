<?php
	...
	if (isset($_POST['mydata'])) {
			...
			// Save file extension
			$updateUser = "UPDATE users SET dniext1 = 'jpg' WHERE user_id = $user_id";
			try
			{
...
$image_fieldname = "fileToUpload";
	...
	if ($_FILES[$image_fieldname]['error'] != 0) {
		...
		header("Location: new-id-scan-front.php?user_id=$user_id");
		exit();
	}
	...
	pageStart($lang['update-dni'], NULL, NULL, "pprofile", "campage", $lang['update-dni'] . " - " . $lang['dni-front'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

?>
<link  href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.7/cropper.min.css" rel="stylesheet">
 <div id='mainbox'>
  <div id='mainboxheader'>
  <?php echo $lang['dni-front']; ?>
  </div>
