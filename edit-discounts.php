...
if ($day != 0) {
    ...
    $(document).ready(function() {
		...
		$('#catHeader').click(function () {
			...
			var x = $("#plus1").attr("src");
			if (x == "images/expand.png") {
		...
		$('#catHeaderB').click(function () {
			$('.catHiddenB').toggle();
			
			var x = $("#plus3").attr("src");
			if (x == "images/expand.png") {
				$("#plus3").attr("src","images/shrink.png");
			
			} else {
				$("#plus3").attr("src","images/expand.png");
			
			}
		});
		$('#prodHeaderB').click(function () {
			$('.prodHiddenB').toggle();
			
			var x = $("#plus4").attr("src");
			if (x == "images/expand.png") {
				$("#plus4").attr("src","images/shrink.png");
			
			} else {
				$("#plus4").attr("src","images/expand.png");
...
<center><span class='cta3' style='padding: 20px;'><?php echo $lang['dispensary']; ?></span></center>
<?php
...
<center><h3 class='title'><?php echo $lang['general-discounts']; ?></h3></center>
  <table class='padded' style='width: 100%;'>
   ...
   <tr>
    <td colspan='6' style='cursor: pointer;' id='catHeader'><center><h3 class='title'><?php echo $lang['category-discounts']; ?> <img src='images/expand.png' id='plus1' width='15' style='margin-left: 5px;' /></h3></center></td>
   </tr>
<?php
	...
	$selectCategoryDiscount = "SELECT discount FROM catdiscounts WHERE user_id = $user_id AND categoryid = 1";
		...
		echo  <<<EOD
			<tr style='display: none;' class='catHidden'>
...
?>
   <tr>
    <td colspan='6' style='cursor: pointer;' id='prodHeader'><center><h3 class='title'><?php echo $lang['product-discounts']; ?> <img src='images/expand.png' id='plus2' width='15' style='margin-left: 5px;' /></h3></center></td>
   </tr>
<?php
	...
	if ($growtype == '') {
		...
		$flowerOutput .= <<<EOD
			<tr class='flowertable' style='display: none;'>
    		 ...
    		 <td class='yellow'></td>
    		 <td>
    		  <input type='text' class='fourDigit defaultinput' id='fijo$d' name='indDiscount[{$d}][purchaseFijo]' value='$prodFijo' step='0.01' /> {$_SESSION['currencyoperator']}
...
EOD;
	...
	$selectCats = "SELECT id, name, type from categories WHERE id > 2 ORDER by id ASC";
		...
		$catProd .= "<tr><td colspan='2' class='yellow prodHidden' style='cursor: pointer; display: none;'>&nbsp;</td></tr>";
		$catProd .= "<tr><td colspan='6' class='yellow prodHidden' style='cursor: pointer; display: none;' id='expand$categoryid'><center><strong class='cta4nm' style='width: 350px;'>$catName $catT &raquo;</strong></center></td></tr>
	<script>
...
EOD;
	...
	echo "<tr><td colspan='6' class='yellow prodHidden' style='cursor: pointer; display: none;' id='flowerexpand'><center><strong class='cta4nm' style='width: 350px;' style='width: 350px;'>{$lang['global-flowerscaps']} (g.) &raquo;</strong></center></td></tr>
	<script>
...
EOD;
	...
	echo "<tr><td colspan='6' class='yellow prodHidden' style='cursor: pointer; display: none;' id='extractexpand'><center><strong class='cta4nm' style='width: 350px;'>{$lang['global-extractscaps']} (g.) &raquo;</strong></center></td></tr>
	<script>
...
<center><h3 class='title'><?php echo $lang['general-discounts']; ?></h3></center>
  <table class='padded' style='width: 100%;'>
   ...
   <tr>
    <td colspan='6' style='cursor: pointer;' id='catHeaderB'><center><h3 class='title'><?php echo $lang['category-discounts']; ?> <img src='images/expand.png' id='plus3' width='15' style='margin-left: 5px;' /></h3></center></td>
   </tr>
<?php
	...
	$e = 0;
		...
		$rowCDB = $result->fetch();
			...
			echo  <<<EOD
				<tr style='display: none;' class='catHiddenB'>
				 <td>$catNameB</td>
				 <td></td>
				 <td></td>
...
?>
   <tr>
    <td colspan='6' style='cursor: pointer;' id='prodHeaderB'><center><h3 class='title'><?php echo $lang['product-discounts']; ?> <img src='images/expand.png' id='plus4' width='15' style='margin-left: 5px;' /></h3></center></td>
   </tr>
<?php
	// First, select categories
	$selectCatsB = "SELECT id, name from b_categories ORDER by id ASC";
		...
		$catProdB .= "<tr><td colspan='2' class='yellow prodHiddenB' style='cursor: pointer; display: none;'>&nbsp;</td></tr>";
		$catProdB .= "<tr><td colspan='6' class='yellow prodHiddenB' style='cursor: pointer; display: none;' id='expandB$categoryidB'><center><strong class='cta4nm' style='width: 350px;'>$catNameB &raquo;</strong></center></td></tr>
	<script>
...
${'title'.$categoryid} = 'set';
		...
		$rowDB = $result->fetch();
			...
			$catProdB .=  <<<EOD
    		 ...
    		 <td class='yellow'></td>
    		 <td>
    		  <input type='text' class='fourDigit defaultinput' id='fijoB$f' name='indDiscountB[{$f}][purchaseFijoB]' value='$prodFijoB' step='0.01' /> {$_SESSION['currencyoperator']}
