...
<div class="adminbox">
 ...
 <div class="linkholder">
  <ul>
   ...
   <li><a href="calls.php">Call Log<sup style='color: red; font-size: 11px; font-weight: 600;'> NEW</sup></a></li>
   <li><a href="list-clients.php">List - clients<sup style='color: red; font-size: 11px; font-weight: 600;'> NEW</sup></a></li>
   <li><a href="list-contacts.php">List - contacts<sup style='color: red; font-size: 11px; font-weight: 600;'> NEW</sup></a></li>
  </ul>
 </div>
</div>
...
<div class="adminbox">
 ...
 <div class="linkholder">
  <ul>
   ...
   <li><a href="invoices.php">Client invoices</a></li>
   <li><a href="special-orders.php">Special orders overview</a></li>
  </ul>
 </div>
</div>
