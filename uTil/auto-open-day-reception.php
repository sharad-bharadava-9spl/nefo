<?php
	...
	// Update flags
	$flagUpdate = "UPDATE closing SET dayOpened = 2, dayOpenedBy = '{$_SESSION['user_id']}', disOpened = 2, disOpenedBy = '{$_SESSION['user_id']}', recOpened = 2, recOpenedBy = '{$_SESSION['user_id']}', dis2Opened = 2, dis2OpenedBy = '{$_SESSION['user_id']}', barOpened = 2, barOpenedBy = '{$_SESSION['user_id']}'  WHERE closingid = $closingid";
	try
	{
