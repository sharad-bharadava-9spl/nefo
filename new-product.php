<?php
	...
	pageStart($lang['pur-newproduct'], NULL, NULL, "pnewstrain", "admin dev-align-center", $lang['pur-newproduct'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

	// Query to look up categories
	// Dabulance customization
	if ($_SESSION['domain'] == 'dabulance') {
		$selectCats = "SELECT id, name, type FROM categories WHERE id > 2 AND shopid = {$_SESSION['shopid']} ORDER by id ASC";
	} else {
