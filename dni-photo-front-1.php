<?php
	...
	if (isset($_GET['snapped'])) {
		...
		$imgname = "images/_$domain/ID/" . $user_id . '-front.jpg';
	...
	pageStart($lang['update-dni'], NULL, NULL, "pprofile", 'dev-align-center', $lang['update-dni'] . " - " . $lang['dni-front'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
