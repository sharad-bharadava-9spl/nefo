...
?>		
	...
	if ($user['userGroup'] > 4 && $exento == 0) {
		...
		$user_row =	sprintf("
	  	  <tr>
	  	   <td class='clickableRow' href='order-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='order-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='order-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='order-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow centered' href='order-2.php?user_id=%d'>%s</td>
	  	   <td class='clickableRow' href='order-2.php?user_id=%d'>%s</td>
		  </tr>",
...
?>
 ...
 <div id='mainbox'>
  ...
  <div class='twoboxessmall'>
   ...
   <form id="registerForm" action="order-2.php" method="POST">
