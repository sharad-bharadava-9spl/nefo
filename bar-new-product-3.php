...
?>
 ...
 <form action="?productid=<?php echo $productid; ?>" method="post" enctype="multipart/form-data" id="crop_form">
...
<a class="skipbutton" href="bar-products.php"><?php echo $lang['skip']; ?></a>
   </form>
</center>
<br>
<?php
