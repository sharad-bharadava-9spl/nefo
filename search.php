<?php
	...
	if (isset($_POST['searchfield'])) {
		...
		$selectUsers = "SELECT u.user_id, u.memberno, u.first_name, u.last_name, u.registeredSince, u.paidUntil, u.userGroup, ug.groupName, u.credit, u.exento FROM users u, usergroups ug WHERE u.userGroup = ug.userGroup AND (u.first_name LIKE ('%$phrase%') OR u.last_name LIKE ('%$phrase%') OR u.memberno LIKE ('%$phrase%')) ORDER by u.memberno ASC";
...
if ($_SESSION['membershipFees'] == 1) {
   ...
   $paidClass, $user['user_id'], $membertill);
	...
	echo sprintf("
  	   <td style='text-align: center;' class='clickableRowNew' href='profile.php?user_id=%d&openComment'>%s</td>
	  </tr>",
...
<form id="registerForm" action="" method="POST">
 <div id="overview">
  <input type="text" name="searchfield" autofocus placeholder="" /><br /><br /><br />  
