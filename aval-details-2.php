...
echo "<br /><div style='margin-left: auto; margin-right: auto; text-align: center;'><img src='images/green-arrow.png' /><br /></center></div>";
...
EOD;
			...
			<tr>
			 ...
			 <td>$groupName</td>
			 <td class='centered'><span style='position: relative;'>$commentRead</span></td>
...
if ($_GET['chain'] != 'true') {
  ...
  <center>";
	...
	if ($_SESSION['domain'] == 'amagi') {
  		echo "<a href='new-member.php?aval2=$origAval' class='fakebutton'>{$lang['continue']}</a></center><br />";
	} else {
  		echo "<a href='new-member-new.php?aval2=$origAval' class='fakebutton'>{$lang['continue']}</a></center><br />";
	}
