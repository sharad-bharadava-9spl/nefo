        ...
        if(!empty($lang == 'es') || !empty($lang == 'en')){
            ...
            $new_arr = array();
                if($resultuser->rowCount() > 0){
                    if($lang=='es')
					{	
                        $response = array('flag' => '1','message' => '¡Club encontrado con éxito!' , 'status' => 'true');
                    }else{
                    ...
                    if($lang=='es')
					{	
                        $response = array('flag' => '0', 'message' => 'Error al localizar el perfil del socio.' ,'status' => 'false');
                    }else{
                        $response = array('flag' => '0', 'message' => 'Error locating member profile.' ,'status' => 'false');
                    }
