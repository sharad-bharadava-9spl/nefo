            ...
            $resultcartData->execute();
                ...
                if($resultcartData->rowCount() > 0){
                    ...
                    if($clubcredit == 1){
                        if($lang=='es')
                        {	
                            $response = array('flag' => '1','message' => '¡Carrito cargado con éxito!','cart_count'=> $resultcartData->rowCount(),'total_price' => $userproducttotal,'user_discountprice' => number_format(abs($user_discountprice),2),'user_discount' => number_format($userdiscounttotal,2),'usercredit_title' => $user_pay_title,'user_credit' =>number_format(abs($user_credit),2),'user_grand_total' => number_format($usergrandtotal,2),'user_credit_detail' => $user_pay_credit,'user_pay_updatecredit_title' => $user_pay_updatecredit_title,'userupdate_credit' => $user_pay_updatecredit,'userupdatecredit' =>number_format($userActualCredit,2),'Top_up_credit' => $topupcredit, 'Pre_order' => $preorder, 'Show_price' => $showprice,'notification_count' => $countnotfication);
                        }else{
                        ...
                        if($lang=='es')
                        {	
                            $response = array('flag' => '1','message' => '¡Carrito cargado con éxito!','cart_count'=> $resultcartData->rowCount(),'total_price' => $userproducttotal,'Top_up_credit' => $topupcredit, 'Pre_order' => $preorder, 'Show_price' => $showprice,'notification_count' => $countnotfication);
                        }else{
                            $response = array('flag' => '1','message' => 'Cart loaded successfully!','cart_count'=> $resultcartData->rowCount(),'total_price' => $userproducttotal,'Top_up_credit' => $topupcredit, 'Pre_order' => $preorder, 'Show_price' => $showprice,'notification_count' => $countnotfication);
                        }
                        //$response = array('flag' => '1','message' => 'Cart Found Successfull','cart_count'=> $resultcartData->rowCount(),'total_price' => $userproducttotal,'Top_up_credit' => $topupcredit, 'Pre_order' => $preorder, 'Show_price' => $showprice,'notification_count' => $countnotfication);
                    }
