...
if(isset($_POST['club_proceed'])){
	...
	//Get the file information
		...
		// Query to update user - 28 arguments
		 $updateUser = sprintf("INSERT INTO customers (registeredSince, longName, shortName, cif, street, streetnumber, flat, postcode, city, state, country, website, email, facebook, instagram, phone, source, member_contract, logo_path, language, club_status) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%d')", 
