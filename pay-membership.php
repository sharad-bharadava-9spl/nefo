...
<div id='donationholder'>
 ...
 <?php
	...
	$selectCuotas = "SELECT id, name, cuota, days FROM cuotas";
		...
		echo "<input type='radio' id='fee$id' name='paidUntil' value='$id' /><label for='fee$id'><span class='full'>$name $cuota".$_SESSION['currencyoperator']."</span></label>";
...
<?php } ?>
 ...
 <!--
    <table>
     ...
     <tr>
      <td><input type="number" lang="nb" name="amount" placeholder="$_SESSION['currencyoperator']" class="fourDigit defaultinput" step="0.01" /></td>
