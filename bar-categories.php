<?php
	...
	$selectCats = "SELECT id, time, name, description, sortorder, icon from b_categories ORDER by sortorder ASC, name ASC";
		try
		{
...
<center><a href="bar-new-category.php" class="cta1"><?php echo $lang['new-category']; ?></a></center>
 <form id="registerForm" action="" method="POST">
	...
	if(trim($icon) != ''){
		...
		$icon_image = "<img src='images/_$domain/bar-category/$icon' height='20' />";
	}
	...
	$flower_row =	sprintf("
	  ...
	  $category['id'], $icon_image, $category['id'], $category['name'], $category['id'], $noOfCats, $i, $sortorder, $i, $categoryid, $categoryid, $noOfCats
	  );
	  echo $flower_row;
