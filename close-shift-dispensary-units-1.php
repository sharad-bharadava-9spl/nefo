...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <textarea class='defauktinput' name='confirmedClose[%d][prodclosecomment]' placeholder='{$lang['global-comment']}'></textarea>
		</div>
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <textarea name='confirmedClose[%d][prodclosecomment]' class='defaultinput' placeholder='{$lang['global-comment']}'></textarea>
		</div>
  	   <input type='hidden' name='confirmedClose[%d][name]' value='%s' />
  	   <input type='hidden' name='confirmedClose[%d][category]' value='%d' />
  	   <input type='hidden' name='confirmedClose[%d][productid]' value='%d' />
