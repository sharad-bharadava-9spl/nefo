<?php
	...
	if ($_POST['step1'] != 'complete' && (!isset($_GET['stepOneSkip'])) && !isset($_GET['recount'])) {
...
EOD;
	...
	pageStart($lang['title-closeday'], NULL, $validationScript, "pcloseday", "step2 dev-align-center", $lang['closeday-rec-two'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<form id="registerForm" action="close-day-reception-2.php" method="POST">
 <div class="actionbox-np2">
    <div class="mainboxheader"><?php echo $lang['all-cash']; ?></div><br />
    <div class="boxcontent">
      ...
      <input type="number" lang="nb" name="hundredEuroFull" id="hundredEuroFull" class="fourDigit defaultinput" placeholder="100<?php echo $_SESSION['currencyoperator'] ?>" value="<?php echo $hundredEuroFull; ?>" />
         <br /><br />
...
<br /><br />
 <div class="actionbox-np2">
     <div class="mainboxheader"><?php echo $lang['till-cash']; ?>   <a href="#" class="cta1" id="aboveValues" style="width: 240px; margin: 0; margin-left: 50px;"><?php echo $lang['use-above-values']; ?></a></div>
  <br /><br />
    <div class="boxcontent">
       <strong><?php echo $lang['coinsC']; ?></strong><br />
      <div class="mainboxheader"></div>
      ...
      <table class="purchasetable">
       <tr>
        <td><?php echo $lang['coins']; ?>
          <input type="number" lang="nb" name="coinsTot" id="coinsTot" class="twoDigit purchaseNumber" value="<?php echo $coinsTot; ?>" readonly /></td>
                  <td><?php echo $lang['notes']; ?>
          <input type="number" lang="nb" name="notesTot" id="notesTot" class="twoDigit purchaseNumber" value="<?php echo $notesTot; ?>" readonly /></td>
                  <td><?php echo $lang['add-total']; ?>
          <input type="number" lang="nb" name="tillTot" id="tillTot" class="twoDigit purchaseNumber" value="<?php echo $tillTot; ?>" readonly /></td>
       </tr>
...
<br /><br />
 <div class="actionbox-np2">
  <div class="boxcontent">
     <div class="mainboxheader"><?php echo $lang['summary']; ?>  </div>

    <table class="purchasetable">
     <tr>
      <td><?php echo $lang['all-cash']; ?>
         <input type="number" lang="nb" name="TotCounted" id="TotCounted" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" class="twoDigit purchaseNumber" value="<?php echo $TotCounted; ?>" readonly /></td>
          <td class="red">- <?php echo $lang['till-cash']; ?>
            <input type="number" lang="nb" name="tillTotCounted" id="tillTotCounted" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" class="twoDigit purchaseNumber red" value="<?php echo $tillTotCounted; ?>" readonly /></td>
          <td><strong><?php echo $lang['closeday-banked']; ?>:</strong>
          <strong><input type="number" lang="nb" name="banked" id="banked" class="twoDigit purchaseNumber" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" value="<?php echo $banked; ?>" readonly /></strong></td>
     </tr>
    </table>
  </div>
</div>
<br />
 <button  class='oneClick cta1' name='oneClick' type="submit"><?php echo $lang['closeday-calculate']; ?></button>
</form>
