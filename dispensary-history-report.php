...
$startIndex1 = 3;                      
	...
	for ($a = 0; $a < $day_num; $a++) {
		...
		$row = $result->fetch();
		    ...
		    $objPHPExcel->getActiveSheet()
		                ->setCellValue('D'.$startIndex1, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < $week_num; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('D'.$startIndex2, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < $month_num; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('D'.$startIndex3, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex4, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex5, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex6, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1,'', $seperator);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex7, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex8, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex9, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex10, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex11, $sales.' '.$_SESSION['currencyoperator']);
	...
	for ($a = 0; $a < 8; $a++) {
		...
		$row = $result->fetch();
			...
			$quantity = number_format($row['SUM(d.realQuantity)'],1);
			    ...
			    $objPHPExcel->getActiveSheet()
			                ->setCellValue('C'.$startIndex12, $sales.' '.$_SESSION['currencyoperator']);
