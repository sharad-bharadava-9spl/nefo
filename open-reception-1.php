...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step1", $lang['openday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

	
?>
		
		<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="open-reception-2.php" method="POST"><br />
...
EOD;
			...
			pageStart($lang['title-openday'], NULL, $testinput, "pcloseday", "step2", $lang['opendayone'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
$(document).on('click keypress keyup blur', function () {
	...
	<form id="registerForm" action="" method="POST" onsubmit="return checkMismatch()"><br />
		<div class="actionbox-np2">
 		...
 		<button class='cta1' name='oneClick' type="submit"><?php echo $lang['confirmtillbal']; ?></button>
</form>
