<?php
	...
	if ($_SESSION['noCompare'] != 'true') {
		...
		$closingLookup = "SELECT oneCent, twoCent, fiveCent, tenCent, twentyCent, fiftyCent, oneEuro, twoEuro, fiveEuro, tenEuro, twentyEuro, fiftyEuro, hundredEuro, coinsTot, notesTot, cashintill, bankBalance FROM recshiftclose ORDER BY closingtime DESC LIMIT 1";
		try
		{
...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step1 dev-align-center", $lang['open-reception'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

	
?>
		
		<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="open-reception-shift-2.php" method="POST"><br />
					 ...
					 <table class="purchasetable">
					  ...
					  <tr>
					   <td><?php echo $lang['tillbalnow']; ?>
					   		<input type="number" lang="nb" name="tillTot" id="tillTot" class="fourDigit purchaseNumber" value="<?php echo $tillTot; ?>" /></td>
					  </tr>
					 </table><br />
