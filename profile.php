<?php
	...
	if ($_SESSION['domain'] == 'dabulance') {
		...
		try
		{
			$result = $pdo3->prepare("SELECT u.user_id, u.memberno, u.registeredSince, u.first_name, u.last_name, u.email, u.day, u.month, u.year, u.nationality, u.gender, u.dni, u.street, u.streetnumber, u.flat, u.postcode, u.city, u.country, u.telephone, u.mconsumption, u.usageType, u.signupsource, u.cardid, u.photoid, u.docid, u.doorAccess, u.friend, u.friend2, u.paidUntil, u.adminComment, ug.userGroup, ug.groupName, ug.groupDesc, u.form1, u.form2, datediff(curdate(), u.registeredSince) AS daysMember, u.paymentWarning, u.paymentWarningDate, u.credit, u.banComment, u.creditEligible, u.dniscan, u.discount, u.discountBar, u.photoext, u.dniext1, u.dniext2, u.workStation, u.bajaDate, u.starCat, u.interview, u.exento, u.fptemplate1, u.usergroup2, u.sigext, u.qrcode FROM users u, usergroups ug WHERE u.userGroup = ug.userGroup AND u.user_id = '{$user_id}'");
			$result->execute();
		}
		catch (PDOException $e)
		{
...
EOD;
	...
	if (isset($_GET['prm'])) {
		...
		$_SESSION['successMessage'] = $lang['document-added'];
...
if ($_SESSION['puestosOrNot'] == 1 && $_SESSION['userGroup'] > 1) {
  ...
  <a href='bar-new-sale-2.php?user_id=$user_id' class='cta'><img src='images/main-baricon.png' height='26' style='margin-right: 3px; margin-bottom: -5px;' /> {$lang['bar']}</a>";
	...
	if (!file_exists($memberPhoto)) {
		...
		$memberPhoto = "<img class='profilepic' src='$memberPhoto?$tn' width='237' />";
...
?>
  ...
  <?php if ($_SESSION['domain'] == '1up' || $_SESSION['domain'] == 'damsquare' || $_SESSION['domain'] == 'koala' || $_SESSION['domain'] == 'nectar' || $_SESSION['domain'] == 'gasstation' || $_SESSION['domain'] == 'hazenberg' || $_SESSION['domain'] == '1up20') { ?>
...
<?php
	...
	echo <<<EOD
   <span class='firsttext'>#$memberno&nbsp;<a href="change-registration-date.php?userid=$user_id" style='font-size: 16px; color: #f6ae4a;'>($membertime)</a></span> <a href="member-contract.php?user_id=$user_id&mconsumption=$mconsumption" target="_blank"><img src="images/contract-new.png" style='margin-bottom: -3px; margin-left: 5px;'/></a><br /><span class='nametext'>$userStar $first_name $last_name</span><br />
...
EOD;
	...
	if($qrcode != ''){
		...
		$qrImg = "<img src='$QRsavePath' height='120'/>";
	}
	echo $qrImg;
?>
 </div>
...
<?php if ($_SESSION['domain'] != 'paradisebilbo' || ($_SESSION['domain'] == 'paradisebilbo' && $_SESSION['userGroup'] == 1)) { ?>
...
<br /><center>
	...
	echo "<br /><br /><br /><h4 style='	text-transform: uppercase;
	font-size: 16px;
	font-weight: bold;
'>{$lang['other-documents']}</h4><br /><div style='text-align: left;'><ul class='normallist'>";
	...
	while ($row = $results->fetch()) {
		...
		echo "<a href='images/_$domain/ID/$user_id-$id.$extension' style='color: #00a48c; font-size: 16px;'><img src='images/document.png' width='10' style='margin-right: 3px; margin-left: 5px;'> $name</a> <a href='uTil/delete-document.php?user_id=$user_id&docid=$id'><img src='images/delete.png' width='12' style='display: inline-block; margin-left: 3px;' /></a><br />";
		
	}
			
			
	echo "
</ul></div><br /><div style='display: inline-block; vertical-align: top; margin-left: 12px;'><a href='add-document.php?user_id=$user_id' class='errorlink'><img src='images/plus-new2.png' height='22' style='margin-bottom: -5px;' /> &nbsp; {$lang['add-document']}</a></div>";
...
// Separate methodologies and row displays (linkage) for donations vs sales. Donations next:
		...
		";
  	   ...
  	   <td class='clickableRow ' href='donation-management.php?userid={$userid}' colspan='6'>{$lang['chips-sold']}</td>
