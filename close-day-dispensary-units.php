...
EOD;
	...
	pageStart($lang['title-closeday'], NULL, $confirmLeave, "pcloseday", "dev-align-center", $lang['closeday-dis2-one'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<?php
	...
	$selectCats = "SELECT DISTINCT category FROM purchases WHERE category > 2 AND ((closedAt IS NULL) OR (closingDate BETWEEN '$openingtime' AND '$closingtime'))";
		...
		if ($catType == 0) {
			...
			echo "<h5 class='title'>$catName</h5><div class='productboxwrap'>";
