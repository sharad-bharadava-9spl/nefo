...
EOD;
	...
	pageStart($lang['title-closeday'], NULL, $confirmLeave, "pcloseday", "step6 dev-align-center", $lang['closeday-dis-two'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		   <div class='mainboxheader'><center><h3 style='margin-bottom: 2px;'>%s %s ($purchaseid)</center></div>
		 %s<br />
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 <div class='mainboxheader'><center><h3 style='margin-bottom: 2px;'>%s ($purchaseid)</center></div>
		 <div class='boxcontent'>
		 <table class='purchasetable'>
		  <tr>
		   <td>{$lang['closeday-openingweight']}
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <tr>
		  <td class='red'>- {$lang['jar-weight']}
		  		<input type='number' lang='nb' name='confirmedClose[%d][tupperWeight]' id='tupperWeight%d' class='fourDigit red purchaseNumber' value='%0.02f' step='0.01' /></td>
		 </tr>
		  <tr>
		   <td>{$lang['add-realweight']}
		   		<input type='number' lang='nb' name='confirmedClose[%d][weight]' id='weight%d' class='fourDigit purchaseNumber' value='%0.02f' step='0.01' %s readonly /></td>
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <tr>
		  <td>{$lang['weightnow']}
		  	<input type='number' lang='nb' name='confirmedClose[%d][fullWeight]' id='fullWeight%d' class='fourDigit' value='%0.02f' step='0.01' /></td>
		 </tr>
		 <tr>
		  <td class='red'>- {$lang['jar-weight']}
		  	<input type='number' lang='nb' name='confirmedClose[%d][tupperWeight]' id='tupperWeight%d' class='fourDigit red' value='%0.02f' step='0.01' /></td>
		 </tr>
		  <tr>
		   <td>{$lang['add-realweight']}
		   	<input type='number' lang='nb' name='confirmedClose[%d][weight]' id='weight%d' class='fourDigit' value='%0.02f' step='0.01' %s readonly /></td>
		  </tr>
		 </table>
		 </div>
		 <!--<br />
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <tr>
		  ...
		  <tr>
		   <td>{$lang['add-realweight']}
		   	<input type='number' lang='nb' name='confirmedClose[%d][weight]' id='weight%d' class='fourDigit purchaseNumber' value='%0.02f' step='0.01' %s readonly />
		   	</td>
		   	<br />
		  </tr>
		 </table></div> <br />
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		  <div class='mainboxheader'><center>%s %s ($purchaseid)</a></center></div>
		 %s<br />
		 <div class='boxcontent'>
		 <table class='purchasetable'>
		  <tr>
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		  <div class='mainboxheader'><center>%s ($purchaseid)</a></center></div>
		  <div class='boxcontent'>
		 <table class='purchasetable'>
		  <tr>
		   <td>{$lang['closeday-openingweight']}
...
<script>
   ...
   function compute() {
	  ...
	  echo $product_row;
		...
		echo "<input type='hidden' name='step3' value='complete' /><br>";
 		echo "<br><button name='oneClick' class='cta1' type='submit'>{$lang['global-confirm']}</button>";
		echo "</form>";
		exit();
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <table class='purchasetable'>
		  ...
		  <tr>
		   <td>{$lang['closeday-estweight']}
		   	<input type='number' lang='nb' name='confirmedClose[%d][estWeight]' id='estWeight%d' class='fourDigit purchaseNumber' value='%0.02f' readonly /><br /></td>
		  </tr>
		 ...
		 <tr>
		  ...
		  <tr>
		   <td><strong>{$lang['global-delta']}:</strong>
		   	<input type='number' lang='nb' name='confirmedClose[%d][weightDelta]' id='weightDelta%d' class='fourDigit%s purchaseNumber' value='%0.02f' step='0.01' readonly /></strong><br />
		  </tr>
		 </table>
		 </div>
		 <br />
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <tr>
		  ...
		  <tr>
		   <td><strong>{$lang['global-delta']}:</strong>
		   	<strong><input type='number' lang='nb' name='confirmedClose[%d][weightDelta]' id='weightDelta%d' class='fourDigit%s purchaseNumber' value='%0.02f' step='0.01' readonly /></strong><br /></td>
		  </tr>
		 </table>
		 </div>
		 <br />
...
<script>
   ...
   function compute() {
		...
		<div class='actionbox-np2'>
		 ...
		 <tr>
		  <td class='red'>- {$lang['jar-weight']}:</td>
		    <input type='number' lang='nb' name='confirmedClose[%d][tupperWeight]' id='tupperWeight%d' class='fourDigit purchaseNumber red' value='%0.02f' step='0.01' /></td>
		 </tr>
		  <tr>
	  ...
	  echo $product_row;
		...
		echo "<input type='hidden' name='step3' value='complete' />";
 		echo "<br><br><br><button name='oneClick' class='cta1' type='submit'>{$lang['global-confirm']}</button>";
		echo "</form>";
		exit();
