<?php 
	...
	if (isset($_GET['setsess'])) {
		$_SESSION['workstation'] = 'dispensary';
	}
			...
			if ($userGroup < 4 && $_SESSION['workertracking'] == 1) {
				...
				if (!$data) {
					...
					if ($data2) {
						...
						echo "<br /><center><a href='?signout&user_id=$user_id' class='cta'>{$lang['global-yes']}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='new-dispense-2.php?user_id=$user_id' class='cta'>{$lang['global-no']}</a></center>";
						...
						echo "<br /><center><a href='?signin&user_id=$user_id' class='cta'>{$lang['global-yes']}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='new-dispense-2.php?user_id=$user_id' class='cta'>{$lang['global-no']}</a></center>";
    ...
    $.ajax({
      ...
      success:function(data)
      {
        if( data == 'false' ) {
	        ...
	        window.location.replace("dispensary.php?notregistered");
		    
	    } else {
	        window.location.replace("new-dispense-2.php?user_id="+data);
	    }
      }
    });
}, 3000);
...
EOD;
	...
	pageStart("CCS", NULL, $testinput, "pindex", "loggedIn", $lang['dispensary'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<?php if ($_SESSION['userGroup'] == 1) { ?>
 ...
 <a href="gallery.php"><span id="galleryCTA"></span><br />Gallery</a>
 <a href="map.php"><span id="mapCTA"></span><br />Map</a>
 <a href="calendar.php"><span id="calendarCTA"></span><br />Calendar</a>
...
<?php if ($_SESSION['lang'] == 'it') { ?>
 ...
 <a href="new-dispense.php"><span id="dispenseCTA"></span><br /><?php echo $lang['index-dispense']; ?><br />&nbsp;</a>
 <a href="menu.php"><span id="productsCTA"></span><br /><?php echo $lang['index-menu']; ?><br />&nbsp;</a>
 <a href="bar-new-sale.php"><span id="barCTA"></span><br /><?php echo $lang['barC']; ?><br />&nbsp;</a><br />
 <a href="scan-profile.php"><span id="profileCTA"></span><br /><?php echo $lang['member-profilecaps']; ?><br />&nbsp;</a>
 <?php if ($_SESSION['fingerprint'] == 1) { ?><a href="scan-finger.php"><span id="fingerCTA"></span><br /><?php echo $lang['fingerprint']; ?></a> <?php } ?>
 <a href="members.php"><span id="membersCTA"></span><br /><?php echo $lang['index-membersC']; ?><br />&nbsp;</a>
 <a href="new-member-0.php"><span id="newmemberCTA"></span><br /><?php echo $lang['index-newmember']; ?><br />&nbsp;</a>
...
<?php if ($_SESSION['lang'] == 'it') { ?>
 ...
 <a href="new-dispense.php"><span id="dispenseCTA"></span><br /><?php echo $lang['index-dispense']; ?><br />&nbsp;</a>
 <a href="menu.php"><span id="productsCTA"></span><br /><?php echo $lang['index-menu']; ?><br />&nbsp;</a><br />
 <a href="scan-profile.php"><span id="profileCTA"></span><br /><?php echo $lang['member-profilecaps']; ?><br />&nbsp;</a>
 <?php if ($_SESSION['fingerprint'] == 1) { ?><a href="scan-finger.php"><span id="fingerCTA"></span><br /><?php echo $lang['fingerprint']; ?></a> <?php } ?>
 <a href="members.php"><span id="membersCTA"></span><br /><?php echo $lang['index-membersC']; ?><br />&nbsp;</a>
...
<?php } else { ?>
 ...
 <a href="new-dispense.php"><span id="dispenseCTA"></span><br /><?php echo $lang['index-dispense']; ?></a>
 <a href="menu.php"><span id="productsCTA"></span><br /><?php echo $lang['index-menu']; ?></a><br />
 <a href="scan-profile.php"><span id="profileCTA"></span><br /><?php echo $lang['member-profilecaps']; ?></a>
 <?php if ($_SESSION['fingerprint'] == 1) { ?><a href="scan-finger.php"><span id="fingerCTA"></span><br /><?php echo $lang['fingerprint']; ?></a> <?php } ?>
 <a href="members.php"><span id="membersCTA"></span><br /><?php echo $lang['index-membersC']; ?></a>
