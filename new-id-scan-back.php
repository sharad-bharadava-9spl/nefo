<?php
	...
	if (isset($_POST['mydata'])) {
		...
		// If not, it means a photo was uploaded. Let's verify it.
			...
			if ($_FILES[$image_fieldname]['error'] != 0) {
				...
				header("Location: new-id-scan-back.php?user_id=$user_id");
				exit();
			}
	...
	pageStart($lang['update-dni'], NULL, NULL, "pprofile", "campage", $lang['update-dni'] . " - " . $lang['dni-back'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

?>
<link  href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.7/cropper.min.css" rel="stylesheet">
 <div id='mainbox'>
  <div id='mainboxheader'>
  <?php echo $lang['dni-back']; ?>
  </div>
