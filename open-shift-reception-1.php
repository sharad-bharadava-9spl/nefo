...
EOD;
	...
	pageStart($lang['start-shift'], NULL, $confirmLeave, "pcloseday", "step1 dev-align-center", $lang['openday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
		...
		<div class="actionbox-np2">	
			<div class="boxcontent">
			 <table class="purchasetable">
			  <tr>
			   <td><?php echo $lang['till-last-close']; ?>
...
EOD;
			...
			pageStart($lang['title-openday'], NULL, $testinput, "pcloseday", "step2 dev-align-center", $lang['openday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
$(document).on('click keypress keyup blur', function () {
    ...
    compareYday();
		...
		<div class="actionbox-np2">	
			<div class="mainboxheader"><?php echo $lang['tillmismatch']; ?></div>
		<div class="boxcontent">	
		 <strong><?php echo $lang['closeday-coins']; ?></strong><br />
		 <div class="mainboxheader"></div>
		 <span class="smallgreen short"><?php echo $lang['last-close']; ?>:</span>
		 ...
		 <span class="smallgreen short"><?php echo $lang['now']; ?>:</span>
		  <div class="mainboxheader"></div>
