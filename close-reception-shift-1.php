...
<table>
 <tr>
  ...
  <td><input type="number" lang="nb" name="TotCounted" id="TotCounted" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" class="fourDigit" value="<?php echo $TotCounted; ?>" readonly /></td>
 </tr>
 <tr>
  <td>- <?php echo $lang['till-cash']; ?>:</td>
  <td><input type="number" lang="nb" name="tillTotCounted" id="tillTotCounted" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" class="fourDigit red" value="<?php echo $tillTotCounted; ?>" readonly /></td>
 </tr>
 <tr>
  <td><strong><?php echo $lang['closeday-banked']; ?>:</strong></td>
  <td><strong><input type="number" lang="nb" name="banked" id="banked" class="fourDigit" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" value="<?php echo $banked; ?>" readonly /></strong></td>
 </tr>
</table>
