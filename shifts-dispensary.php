...
<!--	    <th><?php echo $lang['completed']; ?>?</th>-->
	...
	if ($shifttype == 2) {
		...
		$expense_row =	sprintf("
	  	  <tr>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: left; border-bottom: 4px solid #4d7e3b;'>%s</td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: left; border-bottom: 4px solid #4d7e3b;'>%s</td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: left; border-bottom: 4px solid #4d7e3b;'>%s</td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <td class='clickableRow' href='shift.php?type=%d&id=%d' style='text-align: right; border-bottom: 4px solid #4d7e3b;'>%0.2f <span class='smallerfont'>g.</span></td>
	  	   <!--<td style='border-bottom: 4px solid #4d7e3b;'>%s</td>-->
		  </tr>
",
