...
<table class='defaultalternate'>
 <tr>
  <th style='text-align: left;'><strong>{$lang['global-dispensary']}</strong></th>
  <th><strong>{$expr(number_format($salesToday,2))} {$_SESSION['currencyoperator']}</strong></th>
  <th></th>
  <th><strong>{$expr(number_format($realquantitySold,2))} g.</strong></th>
...
<table class='defaultalternate'>";
	...
	echo <<<EOD
<center>	
 <div class="statusbox"><img src="images/settings-dispensary.png" style="margin-bottom: -7px;">{$lang['bar-and-dispensary']}<br><br>
<table class='defaultalternate'>
 <tr>
...
EOD;
 ...
 <br>
<div class= "statusbox"><img src="images/settings-members.png" style="margin-bottom: -7px;">Member details
<br>
<br>
<table class="defaultalternate">	
 <tr>
 ...
 <div class="statusbox"><img src="images/settings-finances.png" style="margin-bottom: -7px;">{$lang['closeday-finances']}<br><br>
 <table class='defaultalternate'>
 <tr>
  <td style='text-align: left;'>{$lang['closeday-donations-till']}</td>
  <td>{$expr(number_format($donations,2))} {$_SESSION['currencyoperator']}</td>
...
*/
	...
	$productDetails = <<<EOD
<div class='statusbox'>
<table class='defaultalternate'><img src="images/settings-dispensary.png" style="margin-bottom: -7px;">{$lang['closeday-productdetails']}<br><br>
 <tr>
  <th><span style="font-size: 20px; color: #444;">{$lang['global-flowerscaps']}&nbsp;&nbsp;</span></th>
  <th><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></th>
  <th><strong>{$lang['closeday-intstash']}&nbsp;&nbsp;</strong></th>
...
EOD;
		...
		$productOverview = <<<EOD
<div class="statusbox"><img src="images/settings-dispensary.png" style="margin-bottom: -7px;">{$lang['dispensary-overview']}<br><br>
<table class='defaultalternate'>		
 <tr>
  <th><span style='font-size: 20px; color: #444;'>{$lang['grams']}</span></th>
  <th><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></th>
...
<br />
<br /><br /><br />
<div class="statusbox"><img src="images/settings-finances.png" style="margin-bottom: -7px;">{$lang['global-expensescaps']}<br><br>
<table class='defaultalternate'>
	   <tr>
	    <th style='text-align: center;'><strong>{$lang['global-time']}</strong></th>
	    <th style='text-align: center;'><strong>{$lang['global-category']}</strong></th>
