...
EOD;
	...
	pageStart($lang['title-openday'], NULL, $confirmLeave, "pcloseday", "step1  dev-align-center", $lang['openday-dis-one'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

	if ($_SESSION['firstOpening'] != 'true') {
		echo "<a href='uTil/auto-open-day-dispensary.php?cid=$closingid' class='cta1' style='width: 400px;' id='skipCount'>{$lang['dont-weigh']}</a>";
	} else {
		echo "<a href='uTil/auto-open-day-dispensary-first.php' class='cta1' style='width: 400px;' id='skipCount'>{$lang['use-purchase-values']}</a>";
	}
...
<?php
	...
	$flower_row = sprintf("
	 ...
	 <div class='mainboxheader'>%s %s ({$flower['purchaseid']})</div><br />
	    %s 
