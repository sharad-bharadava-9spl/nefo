	...
	<div id="mainbox-no-width">
		<div class="boxcontent">
			<form id="registerForm" action="" method="POST">
			 <input type="text" name="first_name" class="defaultinput" placeholder="<?php echo $lang['member-firstnames']; ?>" /><br />
			 <input type="text" name="last_name" class="defaultinput" placeholder="<?php echo $lang['member-lastnames']; ?>" /><br />
			 <input type="text" name="dni" class="defaultinput" placeholder="DNI" /><br />
			 <textarea name="comment" class="defaultinput" placeholder="<?php echo $lang['reason']; ?>"></textarea><br /><br />
