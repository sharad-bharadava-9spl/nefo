<?php
	...
	$_SESSION['disOpen'] = $openingReadable;
	$_SESSION['disOpenSQL'] = $openingSQL;
			...
			if ($openAndClose > 2) {
		    			...
		    			$query = "SELECT closingid, closingtime FROM shiftclose WHERE closingtime > '$openingSQL' ORDER by closingtime DESC";
						try
						{
						...
						$output .= <<<EOD
   <tr>
    <td class='clickableRow' href='index-split-5.php?ct=$closingtime&cts=$closingtimeSQL' style='padding: 10px; padding-right: 50px;  color: #aaa;'>$openingReadable</td>
    <td class='clickableRow' href='index-split-5.php?ct=$closingtime&cts=$closingtimeSQL' style='padding: 10px;'>$closingtime</td>
   </tr>
EOD;
					...
					echo "<h1>" . $lang['step'] . " 4: " . $lang['choose-dis-closing'] . "</h1>";
