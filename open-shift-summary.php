...
EOD;
	...
	pageStart($lang['start-shift'], NULL, $confirmLeave, "pcloseday", "step5 dev-align-center", $lang['openshift-conf'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
		 ...
		 <table class="purchasetable">
		  ...
		  <tr>
		   <td><?php echo $deltaNow; ?>
		   	<input type="number" lang="nb" name="weightDelta" id="weightDelta" class="fourDigit<?php echo $deltaColour; ?> purchaseNumber" value="<?php echo number_format($weightDelta,2,'.',''); ?>" readonly /></td>
		  </tr>
		 </table><br />
...
echo <<<EOD
<br /><a href='uTil/confirm-open-shift.php?oid=$openingid&cid=$closingid&closer={$_SESSION['user_id']}' class='cta1' id='hidecta'>{$lang['open-shift']}</a><br />
