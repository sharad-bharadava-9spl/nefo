...
EOD;
		pageStart($lang['close-shift'], NULL, $confirmLeave, "pcloseday", "step3 dev-align-center", $lang['closeday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
  ...
  <table class="purchasetable">	 
    ...
    <tr>
	 <td><?php echo $lang['closeday-yourcount']; ?>
	 	<input type="number" lang="nb" name="tillTot" id="tillTot" class="fourDigit purchaseNumber" value="<?php echo $tillTot; ?>" readonly /> <a href="close-shift-reception-1.php?recount" class="recount"><?php echo $lang['closeday-recount']; ?>?</a></td>
    </tr>		 
    <tr>
   ...
   <span class='usergrouptext'> <?php echo $lang['closeday-tillcomment']; ?></span>
