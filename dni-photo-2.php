<?php
	...
	pageStart("DNI / " . $lang['member-passport'], NULL, NULL, "pprofile", 'dev-align-center', "DNI / " . $lang['member-passport'] . " - " . $lang['dni-back'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
