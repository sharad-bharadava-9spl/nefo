...
<html>
 <head>
  ...
  <script type="text/javascript" src="{$siteroot}scripts/tinymce.min.js"></script>
 ...
 <body id="{$bodyID}" class="{$bodyClass}">
  <div id="wrapper">
    <div id="header">
     ...
     <div id="pagecontrols">
     	 <center><a href="{$siteroot}{$currSite}" id="logo"><img src="{$siteroot}images/logo.png" /></a></center><br />
     </div>
