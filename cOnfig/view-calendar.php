...
/******* HEREDOC FUNCTIONS ********/
	...
	function displayHead($pageTitle = "", $meta = NULL, $embeddedJS = NULL) {
	  ...
	  $jsfile = null;
		if ($pageTitle === 'Event' || $pageTitle === 'Time line' || $pageTitle === 'Calendar Access') {
			$cssfile .= "<link rel='stylesheet' href='{$siteroot}css/fullcalendar/core/main.css' type='text/css' />";
			$cssfile .= "<link rel='stylesheet' href='{$siteroot}css/fullcalendar/daygrid/main.css' type='text/css' />";
			$cssfile .= "<link rel='stylesheet' href='{$siteroot}css/fullcalendar/timegrid/main.css' type='text/css' />";
			$cssfile .= "<link rel='stylesheet' href='https://unpkg.com/@fullcalendar/timeline@4.3.0/main.min.css' type='text/css' />";
			$cssfile .= "<link rel='stylesheet' href='https://unpkg.com/@fullcalendar/resource-timeline@4.3.0/main.min.css' type='text/css' />";
			$jsfile .= " <script src='https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js'></script>";
			$jsfile .= " <script src='https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/core/main.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/daygrid/main.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/timegrid/main.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/interaction/main.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/rrule.min.js'></script>";
			$jsfile .= " <script src='{$siteroot}css/fullcalendar/rrule/main.js'></script>";
			$jsfile .= " <script src='https://unpkg.com/@fullcalendar/timeline@4.3.0/main.min.js'></script>";
			$jsfile .= " <script src='https://unpkg.com/@fullcalendar/resource-common@4.3.1/main.min.js'></script>";
			$jsfile .= " <script src='https://unpkg.com/@fullcalendar/resource-timeline@4.3.0/main.min.js'></script>";
...
$('.noEnterSubmit').keypress(function(e){
	...
	$("#note_count").hide();
     function load_unseen_notification(view = '')
		{
		 $.ajax({
		  url:"{$siteroot}fetch-notifications.php",
		  method:"POST",
		  data:{view:view},
		  dataType:"json",
		  async: true,
...
EOD;
		...
		$notification_icon = "<a href='javascript:void(0)' class='note_icon'><img id='note_bell' src='{$siteroot}images/bell.png'><span id='note_count'>0</span></a> $notification_div";
	}
...
//		}
			...
			$helpCenter = "<span class='relative'><a href='{$siteroot}help-center.php'><img src='{$siteroot}images/help-center.png' style='vertical-align: bottom; margin-left: 15px;' /></a>$tooltip</span>";
...
$fzt
  ...
  <div id="wrapper">
    ...
    <div id="pagecontrols">
	 ...
	 &nbsp;&nbsp;<span id="loggedinName"><img src="{$siteroot}images/user.png" style="margin-bottom: -2px;" /> $dispName <img src="{$siteroot}images/flecha.png"  style="margin-bottom: 2px; margin-left: 2px;" /></span> $helpCenter $langswitch <a href='{$siteroot}admin.php'><img src='{$siteroot}images/admin.png' style='vertical-align: bottom; margin-left: 15px;' /></a> <a href='{$siteroot}uTil/logout-manual.php'><img src='{$siteroot}images/logout.png' style='vertical-align: bottom; margin-left: 15px;' /></a> 
     ...
     <a href="{$siteroot}index.php" id="logo"><img src="$logoFile" /></a>
   </div>
     <!--<div id="stafflist">
     {$listcontent}
     </div>
