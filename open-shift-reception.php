...
EOD;
	...
	pageStart($lang['start-shift'], NULL, $confirmLeave, "pcloseday", "step1 dev-align-center", $lang['openday-rec-two'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
		echo "<a href='open-shift-reception-2.php?skipCount' id='skipCount' class='cta1' style='width: 400px;'>{$lang['dont-count']}</a>";
...
<div class='actionbox-np2'>	
 ...
 <br><button class="cta1" name='oneClick' type="submit"><?php echo $lang['closeday-calculate']; ?></button>
</form>
