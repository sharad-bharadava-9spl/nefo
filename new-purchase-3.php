<?php
	...
	// If not, it means a photo was uploaded. Let's verify it.
		...
		if ($_FILES[$image_fieldname]['error'] != 0) {
			...
			header("Location: ?purchaseid=<?php echo $purchaseid; ?>");
			exit();
		}
...
?>
 ...
 <form action="?purchaseid=<?php echo $purchaseid; ?>" method="post" enctype="multipart/form-data">
...
<a class="skipbutton" href="purchase.php?purchaseid=<?php echo $purchaseid; ?>"><?php echo $lang['skip']; ?></a>
   </form>
</center>
<?php
 displayFooter();
