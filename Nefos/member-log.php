<?php
	...
	$selectLog = "SELECT id, logtype, logtime, operator, amount, oldCredit, newCredit, oldExpiry, newExpiry FROM log WHERE user_id = $user_id ORDER by logtime DESC LIMIT 500";
