...
$cloop = 0;
	...
	if ($currCategory != $categoryID) {
		...
		if ($catREAL < 3) {
			...
			$TOTamount = ${'TOTamount' . $currCategory};
		  	...
		  	echo "<td class='clickableRow right' href='purchase.php?purchaseid={$purchaseid}' style='border-bottom: 2px solid #333;'><strong>$TOTamount &euro;</strong></td>";
		  	echo "<td class='clickableRow right' href='purchase.php?purchaseid={$purchaseid}' style='border-bottom: 2px solid #333;'><strong>$purchasePrice &euro;</strong></td><td style='border-bottom: 2px solid #333;'></td></tr>";
		  	$cloop++;
			...
			$TOTamount = ${'TOTamount' . $currCategory};
		  	...
		  	echo "<td class='clickableRow right' href='purchase.php?purchaseid={$purchaseid}' style='border-bottom: 2px solid #333;'><strong>$TOTamount &euro;</strong></td><td style='border-bottom: 2px solid #333;'></td></tr>";
		  	$cloop++;
		  	$currCategory = $catArray[$cloop];
		}
	}
	...
	if ($categoryID < 3) {
		...
		if ($purchasePrice != 0) {
	  	...
	  	echo "<td></td>";
	  	echo "<td class='clickableRow right' href='purchase.php?purchaseid={$purchaseid}'>$amount &euro;</td>";
	  	echo "<td class='clickableRow right' href='purchase.php?purchaseid={$purchaseid}'>$purchasePrice &euro;</td></tr>";
