...
<div class="adminbox">
 ...
 <div class="linkholder">
  <ul>
   ...
   <!--<li><a href="pending-clubs.php">Pending club launches<sup style='color: red; font-size: 11px; font-weight: 600;'> NEW</sup></a></li>-->
  </ul>
 </div>
</div>
...
<div class="adminbox">
 ...
 <div class="linkholder">
  <ul>
   ...
   <li><a href="launched.php">Club launch statistics</a></li>
