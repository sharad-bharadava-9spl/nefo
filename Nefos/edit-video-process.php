<?php
	...
	if (isset($_POST['video_id'])) {
		...
		if(empty($tag) || $tag == ''){
		 ...
		 $updateVideo = "UPDATE help_videos SET video_title_en = '$video_title_en', video_title_es = '$video_title_es',video_title_ca = '$video_title_ca',video_title_fr = '$video_title_fr',video_title_nl = '$video_title_nl',video_title_it = '$video_title_it', tags = '$tag', video_path_en = '$video_location_en', video_path_es = '$video_location_es', video_path_ca = '$video_location_ca', video_path_fr = '$video_location_fr', video_path_nl = '$video_location_nl', video_path_it = '$video_location_it', preview_path = '$preview_location',video_duration_en = '$video_duration_en', video_duration_es = '$video_duration_es',video_duration_ca = '$video_duration_ca', video_duration_fr = '$video_duration_fr', video_duration_nl = '$video_duration_nl', video_duration_it = '$video_duration_it', created_at = '$updateTime' WHERE id=$video_id";  
