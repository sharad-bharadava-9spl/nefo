<?php
	...
	// Look up domain
	$findDomain = "SELECT db_pwd, warning, cutoff FROM db_access WHERE domain = '$domain'";
	try
	{
	...
	$query = "SELECT cif, name, dni, club, address, time, image FROM contract";
	try
	{
...
<p>DE UNA  PARTE, <strong><u><?php echo $name; ?></u></strong> mayor de edad, con D.N.I. n&uacute;mero <strong><u><?php echo $dni; ?></u></strong> y en nombre y representaci&oacute;n de la <strong><u><?php echo $club; ?></u></strong>, en adelante, el "CLIENTE", domiciliada en <strong><u><?php echo $address; ?></u></strong>, <strong><u><?php echo $cif; ?></u></strong>.</p>
...
<p>La finalidad y uso previsto tanto de los datos en sí mismos como de su tratamiento, es prestarle el servicio solicitado o entregarle el producto adquirido. A continuación podrá aceptar las finalidades que crea convenientes marcando su casilla correspondiente, tenga en cuenta que algunas finalidades pueden ser necesarias para poderle prestar el servicio, en el caso de NO marcar dichas casillas, no se podrá prestar/entregar el servicio/producto asociado.</p>
	...
	<div class='fakeboxholder'>	
	 <label class="control">
	  ...
	  <input type="checkbox" name="accept2" id="accept2" checked />
	...
	<div class='fakeboxholder'>	
	 <label class="control">
	  ...
	  <input type="checkbox" name="accept3" id="accept3" checked />
	  <div class="fakebox"></div>
	 </label>
	</div>
	<br />
...
<?php
	$filename = "https://ccsnubev2.com/images/_$domain/sigs/$image.png";
...
<center>
	<div class='fakeboxholder'>
	 <label class="control">
	  ...
	  <input type="checkbox" name="savesig" id="savesig" checked />
	  <div class="fakebox"></div>
	 </label>
	</div>
