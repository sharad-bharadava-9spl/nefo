...
<center>
 ...
 <img src="images/excel.png" style="cursor: pointer;" onclick="tablesToExcel(['mainTable'], ['mainTable'], 'myfile.xls')" value="Export to Excel" />
	...
	$purchase_row =	sprintf("
	  ...
	  $purchase['purchaseid'], $formattedDate, $purchase['purchaseid'], $purchaseCategory, $purchase['purchaseid'], $name, $purchase['purchaseid'], $purchase['purchaseQuantity'], $purchase['purchaseid'], $purchase['purchasePrice'], $purchase['purchaseid'], $purchase['salesPrice'] - $purchase['purchasePrice'], $purchase['purchaseid'], $purchase['salesPrice'], $purchase['purchaseid'], $estStock, $purchase['purchaseid'], $inStashInt, $purchase['purchaseid'], $inDisplay, $purchase['purchaseid'], $inStashExt, $purchase['purchaseid'], $inMenu, $purchase['purchaseid'], $commentRead, $barCodeImg);
