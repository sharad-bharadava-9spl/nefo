...
EOD;
	...
	pageStart($lang['title-closeday'], NULL, $deleteExpenseScript, "pcloseday", "", $lang['closeday-rec-one'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
	echo $_SESSION['pageHeader'];
	
?>

<center><a href="new-expense.php?closeday" class="cta"><?php echo $lang['closeday-addexpense']; ?></a></center>
