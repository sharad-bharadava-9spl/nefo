...
<center><h1>This month's possible misuse (tourist accounts)</h1></center>
...
<br />
	...
	try	{
		...
		// Take first dispense date instead! For new clients!!!!!!!!!!!
		$now = time(); // or your date as well
		$your_date = strtotime($monthBegin);
		$datediff = $now - $your_date;
		
		$daysTotal = round($datediff / (60 * 60 * 24));
...
echo "<table id='mainTable'><tr><td style='padding: 5px;'>DB</td><td style='padding: 5px;'>Member ID</td><td style='padding: 5px;'>Dispenses per day</td></tr>";
