<?php
	...
	if (isset($_POST['shortName'])) {
		...
		$updateUser = sprintf("INSERT INTO customers (registeredSince, Brand, number, longName, shortName, cif, street, streetnumber, flat, postcode, city, state, country, website, email, facebook, twitter, instagram, googleplus, status, type, lawyer, billingType, phone, private, membermodule, source, contact, language, clubtype, size, opened, alias, organic) VALUES ('%s', '%d', '%d', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%d', '%d', '%d', '%d', '%s', '%s', '%d', '%s', '%s', '%s', '%d', '%d', '%s', '%s', '%d')",
...
<table class='profileTable' style='text-align: left; margin: 0;'>
 ...
 <tr>
  ...
  <td>
  <span>
 <input type="radio" name="organic" value="1" style="margin-left: 5px;">Yes</input>
 <input type="radio" name="organic" value="0">No</input>
 </span>
  </td>
 </tr>
 <tr>
