   ...
   function compute2() {
	...
	<div class='displaybox'>
	 ...
	 <center>
  	  ...
  	  <input type='number' lang='nb' class='fourDigit centered calc5' id='realgrcalc%d' name='sales[%d][realGrams]' required='required' placeholder='Real gr.' step='0.01' style='width: 70px;' />
