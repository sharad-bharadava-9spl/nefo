...
EOD;
	...
	if (is_numeric($friend)) {
		...
		$friendDetails = "SELECT memberno, first_name, last_name, friend FROM users WHERE user_id = $friend";
...
<div class='productoverview'>
  <img src="images/members/$user_id.$photoext" height='70' style='display: inline; vertical-align: middle;' />
...
echo $mainAval;
		...
		$resultF = mysql_query($friendDetails)
			or handleError($lang['error-avalload'],"Error loading user: " . mysql_error());
				...
				echo <<<EOD
				<div style='margin-left: auto; margin-right: auto; width: 50%; text-align: center; z-index: 500; position: relative;'><img style='margin-left: -280px;' src='images/double-arrow-purple.png' /></div>
				<table class='default'>
				 <thead>
				  <tr>
