...
<div class="overview">
 ...
 ?>
 <span class="profilefirst"><?php echo $number . " - " . $shortName ?> <a href="<?php echo $contract; ?>" target="_blank" ><img src="images/contract.png" style='margin-bottom: -3px; margin-left: 5px;'/></a></span>
 <br />
