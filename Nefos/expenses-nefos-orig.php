<?php
	...
	$selectExpenses = "SELECT expenseid, registertime, userid, expensetype, expense, moneysource, other, amount, shop, comment, receipt, invoice, expensecategory, photoext, vat, vatamt, brand, paymentdate FROM expenses_nefos $timeLimit ORDER by registertime DESC";
...
while ($expense = mysql_fetch_array($result2)) {
	...
	$expense_row =	sprintf("
	   ...
	   <td class='relative'>$commentRead</td>
  	   <td style='text-align: center;'><a href='edit-expense-nefos.php?expenseid=%d'><img src='images/edit.png' height='15' title='{$lang['expense-edit']}' /></a>&nbsp;&nbsp;<a href='javascript:delete_expense(%d)'><img src='images/delete.png' height='15' title='{$lang['expense-delete']}' /></a></td>
	  </tr>",
	  $expense['expenseid'], $expense['expenseid'], $formattedDate, $expense['expenseid'], $formattedDate2, $expense['expenseid'], $formattedTime, $expense['expenseid'], $expenseCat, $expense['expenseid'], $expense['expense'], $expense['expenseid'], $expense['shop'], $expense['expenseid'], $member, $expense['expenseid'], $expense['amount'], $expense['expenseid'], $vatAmount, $expense['expenseid'], $source, $recClass, $expense['expenseid'], $receipt, $invClass, $expense['expenseid'], $invoice, $invScan, $expense['expenseid'], $expense['expenseid']
	  );
	  echo $expense_row;
  }
?>
