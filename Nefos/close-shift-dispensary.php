...
EOD;
	...
	if ($dayClosedNo > 0) {
		$query = "DELETE from shiftclosedetails WHERE closingid = $dayClosedNo";
...
EOD;
	...
	pageStart($lang['close-shift'], NULL, $deleteExpenseScript, "pcloseday", "", $lang['closeday-dis-one'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
