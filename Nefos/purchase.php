<?php
	...
	if (isset($_GET['reopen'])) {
		...
		echo <<<EOD
<a href="uTil/reopen-purchase.php?purchaseid=$purchaseid" class="cta">{$lang['pur-reopen']}</a> <a href="new-purchase.php" class="cta">{$lang['newpurchase']}</a>
EOD;
...
<a href="closed-purchases.php" class="cta"><span class="ctatext">&laquo; <?php echo $lang['purchases']; ?></span></a>
<?php } else { ?>
<a href="open-purchases.php" class="cta"><span class="ctatext">&laquo; <?php echo $lang['purchases']; ?></span></a>
<?php } ?>
<a href="edit-purchase.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext"><?php echo $lang['global-edit']; ?></span></a>
<a href="parts.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext"><?php echo $lang['global-edit']; ?></span></a>
<!--<a href="add-product.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext">Add to jar</span></a>
<a href="remove-product.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext">Remove from jar</span></a>-->
<?php
	if ($closedAt == NULL) {
		echo "<a href='add-or-remove.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-addremove']}</span></a>";
		echo "<a href='close-purchase-2.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-close']}</span></a>";
	} else {
		//echo "<a href='uTil/reopen-purchase.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-reopen']}</span></a>";
 ...
 <div class='infobox'>
  ...
  <table>
   ...
   <tr>
    ...
    <td class="biggerNumber right"><?php echo $purchaseQuantity; ?> g</td>
   </tr>
   <tr>
    <td class="biggerFont left"><?php echo $lang['add-realweight']; ?></td>
    <td class="biggerNumber right"><?php echo $realQuantity; ?> g</td>
   </tr>
   <tr>
    <td class="biggerFont left"><?php echo $lang['closeproduct-reloads']; ?></td>
    <td class="biggerNumber right"><?php echo number_format($totalReloads,2); ?> g</td>
   </tr>
   <tr style="border-bottom: 1px solid #eee;">
    <td class="biggerFont left"><?php echo $lang['closeday-added']; ?></td>
    <td class="biggerNumber right"><?php echo number_format($shakeAdded,2); ?> g</td>
   </tr>
   <tr style="border-bottom: 2px solid #eee;">
    <td class="biggerFont left"><?php echo $lang['add-totalpurchased']; ?></td>
    <td class="biggerNumber right"><?php echo number_format($totalPurchased,2); ?> g</td>
   </tr>
...
<?php
	if ($closedAt != NULL) {
		...
		echo "
   <tr>
    <td class='biggerFont left'>{$lang['pur-closedat']}:</td>
...
?>
   ...
   <tr>
    ...
    <td class="biggerNumber right"><?php echo $tupperWeight; ?> g</td>
   </tr>
   <tr>
...
?>
 ...
 <div class='infobox fullwidth2'>
  ...
  <table>
   <tr>
    <td class="left"><?php echo $lang['add-pergram']; ?></td>
 ...
 <div class='infobox fullwidth2'>
  ...
  <table>
   <tr>
    ...
    <td class="bigNumber right"><?php echo number_format($estStock,2); ?> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['pur-displayjar']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($inDisplay,2); ?> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['intstash']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($inStashInt,2); ?> g</td>
   </tr>
   <tr style="border-bottom: 1px solid yellow;">
    <td class="left"><?php echo $lang['extstash']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($inStashExt,2); ?> g</td>
   </tr>
   <tr>
    <td class="left"><strong><?php echo $lang['global-total']; ?>:</strong></td>
    <td class="bigNumber right"><strong><?php echo number_format($totalProduct,2); ?> g</strong></td>
   </tr>
  </table>
...
<?php if ($noOpening != 'true') { ?>
  ...
  <table>
   <tr>
    <td class="left"><?php echo $lang['global-stock']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($realStock,2); ?> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['pur-displayjar']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($inDisplay,2); ?> g</td>
   ...
   <tr>
    <td class="left"><strong><?php echo $lang['global-total']; ?>:</strong></td>
    <td class="bigNumber right"><strong><?php echo number_format($totalRealProduct,2); ?> g</strong></td>
   </tr>
  </table>
...
<?php 
	...
	if (isset($_GET['summary'])) {
		...
		// Query to look up movements
		$selectMovements = "SELECT movementid, movementtime, type, purchaseid, quantity, movementTypeid, comment FROM productmovements WHERE purchaseid = $purchaseid ORDER by movementtime ASC";
...
<a href="open-purchases.php" class="cta"><span class="ctatext">&laquo; <?php echo $lang['purchases']; ?></span></a>
<a href="edit-purchase.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext"><?php echo $lang['global-edit']; ?></span></a>
<a href="parts.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext">Parts</span></a>
<?php
	if ($closedAt == NULL) {
		echo "<a href='add-or-remove.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-addremove']}</span></a>";
		echo "<a href='close-purchase-2.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-close']}</span></a>";
