<?php
	...
	if (isset($_POST['expense'])) {
		...
		$updateExpense = sprintf("UPDATE expenses_mkl SET userid = '%d', expense = '%s', moneysource = '%d', other = '%s', amount = '%f', shop = '%s', comment = '%s', receipt = '%d', invoice = '%d', expensecategory = '%d', moneysource = '%d', registertime = '%s', vat = '%f', vatamt = '%f', brand = '%d', type = '%d', status = '%d', country = '%s', subcat = '%d' WHERE expenseid = '%d';",
$userid,
$expense,
$moneysource,
$other,
...
$expenseid
		...
		// Query to update expense
		$updateExpense = sprintf("UPDATE expenses_mkl SET userid = '%d', expense = '%s', moneysource = '%d', other = '%s', amount = '%f', shop = '%s', comment = '%s', receipt = '%d', invoice = '%d', expensecategory = '%d', moneysource = '%d', registertime = '%s', vat = '%f', vatamt = '%f', brand = '%d', paymentdate = '%s', type = '%d', status = '%d', country = '%s', subcat = '%d' WHERE expenseid = '%d';",
$userid,
$expense,
$moneysource,
$other,
...
EOD;
	...
	$selectExpenses = "SELECT expenseid, registertime, userid, expensetype, expense, moneysource, other, amount, shop, comment, receipt, expensecategory, invoice, vat, brand, paymentdate, type, status, country, subcat FROM expenses_mkl WHERE expenseid = $expenseid";
		try
		{
...
<span class="fakelabel">Brand:</span>
<span>
 <input type="radio" name="brand" value="0" style="margin-left: 5px;"<?php if ($brand == 0) { echo " checked"; }?>>Nefos</input>
 <input type="radio" name="brand" value="1"<?php if ($brand == 1) { echo " checked"; }?>>CCS</input>
 </span>
<br />
...
<span>
 <input type="radio" name="type" value="1" style="margin-left: 3px;"<?php if ($type == 1) { echo " checked"; }?>>Goods</input>
 <input type="radio" name="type" value="2" style="margin-left: 3px;"<?php if ($type == 2) { echo " checked"; }?>>Services</input>
</span>
<br />
<span class="fakelabel" style="margin-top: 5px;">Status:</span>
<span>
 <input type="radio" name="status" value="1" style="margin-left: 3px;"<?php if ($status == 1) { echo " checked"; }?>>Business</input>
 <input type="radio" name="status" value="2" style="margin-left: 3px;"<?php if ($status == 2) { echo " checked"; }?>>Private</input>
</span>
<br /><br />
