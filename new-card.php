<?php
	...
	$price = $_GET['fee'];
		...
		if ($_GET['bank'] == 'true') {
			...
			$addFee = "INSERT INTO card_purchase (time, userid, operatorid, amount, paidTo) VALUES ('$insertTime', $user_id, $operatorId, $price, 2)";
			
		} else if ($_GET['bank'] == 'saldo') {
		
			$addFee = "INSERT INTO card_purchase (time, userid, operatorid, amount, paidTo) VALUES ('$insertTime', $user_id, $operatorId, $price, 3)";
			
		} else {
			
			$addFee = "INSERT INTO card_purchase (time, userid, operatorid, amount, paidTo) VALUES ('$insertTime', $user_id, $operatorId, $price, 1)";
