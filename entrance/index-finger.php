...
function getREGID(ridval){
	...
	if(vidstart == 1){
	   ...
	   window.location = "id.php?user_id="+empno; //MUITHI | STATUS IN/OUT NOT NEEDED | 29-JAN-2014 | 10-SEPT-2015 | 04-JULY-2016
	}
...
<body>
<a href="index.php" style="border: 1px solid white !important; color: white !important;"><img src="../images/logo.png" style="margin-left: 50px;" /></a><br /><br />
<center>
