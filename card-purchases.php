...
EOD;
	...
	pageStart($lang['chips-sold'], NULL, $deleteDonationScript, "pmembership", NULL, $lang['chips-sold'], $_SESSION['successMessage'], $_SESSION['errorMessage']);


?>
  <center><a href="#"  onclick="loadExcel();"><img src="images/excel-new.png" style='margin: 0 0 -5px 8px;'/></a><br><br><br>
<div id='filterbox'>
...
<?php
	...
	if ($dTime != $currDate) {
		...
		$amountRow = $result->fetch();
			...
			echo "<tr><td colspan='4'><strong>TOTAL:</strong></td><td style='text-align: right;'><strong>$amountToday {$_SESSION['currencyoperator']}</strong></td></tr>";
		}
...
<script type="text/javascript">
	 function loadExcel(){
 			...
 			var filter = "<?php echo $_POST['filter'] ?>";
       		window.location.href = 'card-purchases-report.php?filter='+filter;
       		    setTimeout(function () {
			        $("#load").hide();
			    }, 5000);   
       }
