...
//  echo "<pre>";
//  print_r($arrayKey);
//  echo  getHighest($remQty,$arrayKey)."<br>";
//  echo  max(array_keys($volumeArray))."<br>";
//  echo "Result is : ".(in_array($remQty,array_keys($volumeArray)));
        ...
        if($happy_hour_id){
            ...
            if ($prodFijoHD != 0 || $prodFijoHD != '') {
                ...
                if($prodFijoHD > $dispDiscount1){
                   ...
                   // $price = number_format($totProdFijoHD, 2);
                }
