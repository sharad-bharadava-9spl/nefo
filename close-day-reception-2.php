...
EOD;
		...
		pageStart($lang['title-closeday'], NULL, $confirmLeave, "pcloseday", "step3 dev-align-center", $lang['closeday-rec-three'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<div class="actionbox-np2">
	 <div class="mainboxheader"><?php echo $lang['closeday-tillbalance']; ?></div>
	...
	<?php } ?>
	 ...
	 <table class="purchasetable">
	    <tr>
		 ...
		 <tr>
		 <td class="red">- <?php echo $lang['banked-during-day']; ?>
	 ...
	 <table class="purchasetable">	 
	    <tr>
		 ...
		 <tr>
		 	...
		 	<input type="number" lang="nb" name="tillTot" id="tillTot" class="fourDigit purchaseNumber" value="<?php echo $tillTot; ?>" readonly /> <a style="color: #00a48c; font-size: 10px;" href="close-day-reception-1.php?recount" class="recount">(<?php echo $lang['closeday-recount']; ?>)</a></td>
		 </tr>
		 <tr>
		 		 <td><strong><?php echo $lang['global-delta']; ?></strong>
					<input type="number" lang="nb" name="tillDelta" id="tillDelta" class="fourDigit purchaseNumber" value="<?php echo number_format($tillDelta,2,'.',''); ?>" readonly />
				</td>
	    </tr>		 
	 </table>		 
	  	...
	  	<br><br>
		 <span class='usergrouptext'><?php echo $lang['closeday-tillcomment']; ?></span><br />
		 <textarea name="tillComment" class="defaultinput" placeholder="Comment?"></textarea>
</div><br>	
