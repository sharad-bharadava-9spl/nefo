<?php
	...
	$openingLookup = "SELECT openingid, openingtime, tillBalance, bankBalance, dayClosed AS closed, openedby FROM recopening UNION ALL SELECT openingid, openingtime, tillBalance, bankBalance, shiftClosed AS closed, openedby FROM recshiftopen ORDER BY openingtime DESC LIMIT 1";
		try
		{
	...
	$updateOpening = sprintf("UPDATE recopening SET dayClosed = '1', dayClosedBy = '%d' WHERE openingid = '%d';",
		$responsible,
		$openingid
	);
		try
...
<center><a href="new-expense.php?closeshift" class="cta1"><?php echo $lang['closeday-addexpense']; ?></a></center>
...
<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="close-reception-shift-1.php" method="POST"><br />
