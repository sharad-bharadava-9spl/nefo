<?php
	...
	if ((isset($_POST['newpic'])) && ($_POST['pic2'] == 'yes')) {
		...
		header("Location: reg-7.php?user_id={$user_id}");
		exit();
	}
	/***** FORM SUBMIT END *****/
		...
		if (isset($_POST['mydata'])) {
			...
			$imgname = "images/_$domain/ID/" . $nextMemberNo . '-front.jpg';
...
?>
	...
	<!-- A button for taking snaps -->
		<div id="pre_take_buttons">
			...
			<a class="cta" href="reg-7.php?user_id=<?php echo $user_id; ?>" style='background-color: red; margin: 0; margin-left: 3px; width: 162px;'><?php echo $lang['skip']; ?></a>
		</div>
