...
<br />
<span class="fakelabel"><?php echo $lang['global-amount']; ?>:</span><input type="number" lang="nb" name="amount" placeholder="<?php echo $_SESSION['currencyoperator'] ?>" class="fourDigit" />
<br />
