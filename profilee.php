...
?>
 ...
 <span class="secondbuttons">
  ...
  <a href="member-log.php?user_id=<?php echo $user_id; ?>&chain=true" class="cta">Log</a>
...
<?php	
	if (file_exists($file)) {
		echo "<a href='images/_$domain/ID/" . $user_id . "-front." . $dniext1 . "'><img src='images/dni-iconbig.png' style='margin-top: 10px;'/></a> <a href='new-id-scan-front.php?user_id=$user_id'><img src='images/edit-dnibig.png' style='display: inline-block; margin-left: 5px; margin-bottom: 2px;' /></a><a href='uTil/delete-id-front.php?user_id=$user_id'><img src='images/delete.png' width='15' style='display: inline-block; margin-left: 10px; margin-bottom: 4px;' /></a> <br />";
	} else {
	...
	if (file_exists($file2)) {
		echo "<a href='images/_$domain/ID/" . $user_id . "-back." . $dniext2 . "'><img src='images/dni-icon-2big.png' style='margin-top: 10px;' /></a> <a href='new-id-scan-back.php?user_id=$user_id'><img src='images/edit-dnibig.png' style='display: inline-block; margin-left: 8px; margin-bottom: 2px;' /></a><a href='uTil/delete-id-back.php?user_id=$user_id'><img src='images/delete.png' width='15' style='display: inline-block; margin-left: 10px; margin-bottom: 4px;' /></a>  <br />";
	} else {
