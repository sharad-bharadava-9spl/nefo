...
<style type="text/css">
	...
	$_SESSION['disClose'] = $closingReadable;
	$_SESSION['disCloseSQL'] = $closingSQL;
...
<table class='defaultalternate'>
 <tr>
  ...
  <th>{$expr(number_format($salesToday,2))} &euro;</th>
  <th></th>
...
<div class="statusbox">
 ...
 <table class='defaultalternate'>
 <tr>
  <th style='text-align: left;'>{$lang['closeday-newmembers']}</th>
  <th>$newmembers</th>
  <th></th>
  <th></th>
  <th></th>
...
EOD;
 ...
 <tr>
  ...
  <td>{$expr(number_format($prodPrice,2))} &euro;</td>
  <td>{$expr(number_format($weightDelta,2))} g.</td>
  <td>{$expr(number_format($deltaPrice,2))} &euro;</td>
...
EOD;
 ...
 <tr>
  ...
  <td>{$expr(number_format($flowerDeltaPrice,2))} &euro;</td>
 ...
 <tr>
  ...
  <td>{$expr(number_format($extractDeltaPrice,2))} &euro;</td>
...
EOD;
 ...
 <tr>
  ...
  <td>{$expr(number_format($otherTotals[$category]['otherWeightPrice'],2))} &euro;</td>
  <td>{$expr(number_format($stockDelta,2))} g.</td>
  <td>{$expr(number_format($otherTotals[$category]['otherDeltaPrice'],2))} &euro;</td>
EOD;
				if ($_SESSION['realWeight'] == 1) {
...
<div class='statusbox'>
 ...
 <table class='defaultalternate'>
 <tr>
  <td><span style='font-size: 20px;color: #444;'>{$lang['global-flowerscaps']}</span></td>
...
EOD;
	  ...
	  echo "</table></div>";
			...
			$recOpenSQL = $_SESSION['recOpenSQL'];
			$recCloseSQL = $_SESSION['recCloseSQL'];
			$disOpenSQL = $_SESSION['disOpenSQL'];
			$disCloseSQL = $_SESSION['disCloseSQL'];
			$recOpen = $_SESSION['recOpen'];
			$recClose = $_SESSION['recClose'];
			$disOpen = $_SESSION['disOpen'];
			$disClose = $_SESSION['disClose'];
			
			if ($recOpenSQL < $disOpenSQL) {
				$openingSQL = $recOpenSQL;
				$reportDateReadable = $recOpen;
			} else {
				$openingSQL = $disOpenSQL;
				$reportDateReadable = $disOpen;
			}
			if ($recCloseSQL > $disCloseSQL) {
				$closingSQL = $recCloseSQL;
				$reportDateReadable .= " - " . $recClose;
			} else {
				$closingSQL = $disCloseSQL;
				$reportDateReadable .= " - " . $disClose;
			}
		...
		$row = $result->fetch();
			...
			echo "<h3 class='title'>$reportDateReadable</h3>";
...
EOD;
	...
	EOD;
		 ...
		 <tr>
		  ...
		  <th>{$expr(number_format($barSales,2))} &euro;</th>
		  <th></th>
		  <th></th>
		  <th></th>
		  <th></th>
...
EOD;
 ...
 <tr>
  <td><span style='font-size: 20px; color: #444;'>$categoryname (g.)</span></td>
  <td><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></td>
  <td><strong></strong></td>
  <td><strong>{$lang['closeday-intstash']}&nbsp;&nbsp;</strong></td>
  <td><strong>{$lang['closeday-extstash']}&nbsp;&nbsp;</strong></td>
...
EOD;
 ...
 <tr>
  <td><span style='font-size: 20px; color: #444;'>$categoryname (u.)</span></td>
  <td><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></td>
  <td><strong></strong></td>
  <td><strong>{$lang['closeday-intstash']}&nbsp;&nbsp;</strong></td>
  <td><strong>{$lang['closeday-extstash']}&nbsp;&nbsp;</strong></td>
...
<div class='statusbox'>
 ...
 <table class='defaultalternate'>
 <tr>
  <td><span style='defaultalternate'>{$lang['global-flowerscaps']}</span></td>
  <td><strong>{$lang['closeday-jars']}&nbsp;&nbsp;</strong></td>
  <td><strong>{$lang['closeday-woshake']}&nbsp;&nbsp;</strong></td>
  <td><strong>{$lang['closeday-intstash']}&nbsp;&nbsp;</strong></td>
  <td><strong>{$lang['closeday-extstash']}&nbsp;&nbsp;</strong></td>
...
EOD;
	  ...
	  echo "</table></div>";
		...
		$row = $result->fetch();
			...
			echo "<h3 class='title'>$reportDateReadable</h3><br>";
...
<br>
<div class='statusbox'>
<img src="images/settings-dispensary.png" style="margin-bottom: -7px;"> {$lang['closeday-productoverview']}<br>
<br>
<table class='defaultalternate'>
EOD;
