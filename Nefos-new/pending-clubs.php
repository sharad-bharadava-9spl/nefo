<?php
 ...
 if (isset($_GET['pageno']) && $_GET['pageno'] != '') {
	...
	$selectClubs = "SELECT id, registeredSince, longName, cif, city, state, country, website, email, phone, language, club_status FROM customers WHERE  1 AND autolaunch = 1 $timeLimit ORDER by registeredSince DESC LIMIT $offset, $no_of_records_per_page";
		try
		{
...
EOD;
	pageStart("Pending club launches", NULL, $deleteSaleScript, "pclubs", "clubs admin", "", $_SESSION['successMessage'], $_SESSION['errorMessage']);
