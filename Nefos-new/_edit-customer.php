...
function load2(){
 ...
 <tr>
  ...
  <td>
   <input type="number" lang="nb" id="vat" class="twoDigit memberGroup" name="vat" value="<?php echo $vat; ?>"  />
  </td>
 </tr>
 <tr>
