<?php
	...
	if (isset($_POST['name'])) {
		...
		$updateUser = sprintf("INSERT INTO accountants (name, telephone, email, street, streetnumber, flat, postcode, city, state, country) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
...
$country
		...
		// On success: redirect.
		$_SESSION['successMessage'] = "accountant added succesfully!";
...
EOD;
	...
	pageStart("New accountant", NULL, $validationScript, "pprofile", NULL, "New accountant", $_SESSION['successMessage'], $_SESSION['errorMessage']);
