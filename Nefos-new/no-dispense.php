<?php
	...
	pageStart("No puede dispensar", NULL, $deleteNoteScript, "pminiprofile", NULL, "NO PUEDE DISPENSAR", $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<center>
 <div id='profilearea'>
  <img src='images/members/$user_id.jpg' />
  <h4>#$memberno - $first_name $last_name</h4>";
	...
	if ($usageType == 'Medicinal') {
		echo "<br /><img src='images/medical-22.png' lass='warningIcon' style='margin-bottom: -3px; margin-left: 7px; margin-right: 2px;' /> <span class='yellow'>Medicinal user</span>";
	}
