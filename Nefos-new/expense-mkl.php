<?php
	...
	$selectExpense = "SELECT expenseid, registertime, userid, expensetype, expense, moneysource, other, amount, shop, comment, receipt, invoice, expensecategory, vatamt FROM expenses_mklnew WHERE expenseid = $expenseid";
		try
		{
	...
	pageStart($lang['title-expense'], NULL, NULL, "pexpenses", "admin", $lang['global-expense'] . " mkl", $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
?>

<center><a href="expenses-mkl.php" class="cta">&laquo; Expenses</a>&nbsp;<a href="edit-expense-mkl.php?expenseid=<?php echo $expenseid; ?>" class="cta"><?php echo $lang['expense-edit']; ?></a></center>
