<?php
	...
	$selectExpenseTot = "SELECT SUM(amount), SUM(vatamt) FROM expenses_nefos WHERE brand = 0 $timeLimit";
		try
		{
	...
	$selectExpenseTot = "SELECT SUM(amount), SUM(vatamt) FROM expenses_nefos WHERE brand = 1 $timeLimit";
		try
		{
			$result = $pdo3->prepare("$selectExpenseTot");
			$result->execute();
	...
	// Query to look up expenses
	$selectExpenseTot = "SELECT SUM(amount), SUM(vatamt) FROM expenses_nefos $timeLimit2";
	...
	// Query to look up expenses
	$selectExpenseTot = "SELECT e.expensecategory, SUM(e.amount), SUM(e.vatamt), brand FROM expenses_nefos e, expensecategories c WHERE e.expensecategory = c.categoryid $timeLimit GROUP BY brand, expensecategory ORDER BY c.nameen ASC";
		try
		{
