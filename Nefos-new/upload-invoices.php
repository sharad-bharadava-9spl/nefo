<?php
	...
	foreach ($files as $file) {
		...
		if (strpos($file, 'pdf') !== false) {
			...
			rename("../../ccsnubev2_com/invoices/" . $file, "../../ccsnubev2_com/v6/_club/_$domain/invoices/$file");
			
			echo "MOVED: " . "../../ccsnubev2_com/invoices/" . $file, "../../ccsnubev2_com/v6/_club/_$domain/invoices/$file" . "<br />";
			$i++;
		}
	}
