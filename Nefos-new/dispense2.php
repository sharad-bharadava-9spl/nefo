...
<br /><br />
	 ...
	 <table>
		<tr>
			...
			<td class='centered'><input type='text' name='invoice_date' class='defaultinput' id='date1' value='".date('Y-m-d')."' autocomplete='off' style='width: 50%;'></td>
			<td class='centered'>Invoice Due Date : </td>
			<td class='centered'><input type='text' name='invoice_due_date' class='defaultinput' id='date2' value='".date('Y-m-d')."' autocomplete='off' style='width: 50%';></td>
