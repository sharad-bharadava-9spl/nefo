<?php
	...
	$selectUsers = "SELECT id, number, shortName, longName, phone, email, language, instagram, facebook, prospect_mail, prospect_facebook, prospect_instagram, prospect_call, prospect_visit, registeredSince, status, launchdate, prospect_demo, prospect_demoDate, organic, country, city, addedBy FROM customers WHERE status < 5 AND DATE(registeredSince) IS NOT NULL $organic ORDER BY id DESC";
...
?>
  ...
  <center><a href='?organic' class='cta1'>Organic</a>
  <a href='?nonorganic' class='cta1'>Non-organic</a>
  <a href='?all' class='cta1'>ALL</a></center>
...
EOD;
	...
	echo <<<EOD
  	   <tr>
  	    ...
  	    <td class='clickableRow' href='customer.php?user_id=$id'>$operator</td>
  	    ...
  	    <td class='clickableRow noExl' href='customer.php?user_id=$id'>$email</td>
  	    <td class='clickableRow noExl' href='customer.php?user_id=$id'>$phone</td>
  	    <td class='clickableRow noExl' href='customer.php?user_id=$id'>$instagram</td>
  	    <td class='clickableRow noExl' href='customer.php?user_id=$id'>$facebook</td>
  	    ...
  	    <td class='' href='customer.php?user_id=$id'><center>$prospect_visit</center></td>
  	    <td class='' href='customer.php?user_id=$id'><center>$prospect_demo</center></td>
  	    <td class='noExl' href='customer.php?user_id=$id'><center>$commentShow</center></td>
  	   </tr>
EOD;
