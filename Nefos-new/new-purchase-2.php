<?php
	...
	if ($extstash > 0) {
		...
		header("Location: new-purchase-3.php?purchase=saved");
		exit();
	}
	/***** FORM SUBMIT END *****/
...
if ($productnumber) {
	echo "
  <tr>
   <td>{$lang['product-number']}:</td>
   <td class='yellow fat'>" . sprintf('%03d', $productnumber) . "</td>
  </tr>";
}
?>
 </table>
 ...
 <div class='infobox'>
  ...
  <table>
   <tr>
    ...
    <td class='left'><input type="number" lang="nb" class="fourDigit dotToComma" id="purchaseQuantity" name="purchaseQuantity" /> g</td>
   </tr>
   <tr>
    <td class="biggerFont left"><?php echo $lang['add-realweight']; ?>:</td>
    <td class='left'><input type="text" lang="nb" class="fourDigit" id="realQuantity" name="realQuantity" /> g</td>
   </tr>
<?php if ($category == '1') { ?>
   <tr>
...
<?php } ?>
   ...
   <tr>
    ...
    <td class='left'><input type="checkbox" name="inMenu" id="inMenu" style="width: 12px; margin-left: 30px;" value="1" /></td>
   </tr>
   <tr>
    <td></td>
    <td></td>
   ...
   <tr>
    ...
    <td class='left'><input type="number" lang="nb" class="fourDigit" id="tupperWeight" name="tupperWeight" /> g</td>
   </tr>
   <tr>
    <td colspan="2"></td>
   </tr>
...
?>
 ...
 <div class='infobox fullwidth'>
  ...
  <table>
   <tr>
    <td class="left"><?php echo $lang['add-sampletaste']; ?></td>
    <td><input type='number' lang='nb' class='fourDigit' name='sample' /> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['add-displayjar']; ?></td>
    <td><input type='number' lang='nb' class='fourDigit' name='displayjar' /> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['add-stashedint']; ?></td>
    <td><input type='number' lang='nb' class='fourDigit' name='intstash' /> g</td>
   </tr>
   <tr>
    <td class="left"><?php echo $lang['add-stashedext']; ?></td>
    <td><input type='number' lang='nb' class='fourDigit' name='extstash' /> g</td>
   </tr>
  </table>
   </div>
...
<div class='leftblock'>
 <div class='infobox'>
  ...
  <table>
   <tr>
    <td class="biggerFont left"><?php echo $lang['add-amountpurchased']; ?>:</td>
    <td class='left'><input type="number" lang="nb" class="fourDigit" id="purchaseQuantity" name="purchaseQuantity" /></td>
   </tr>
   <tr>
    <td class="biggerFont left"><?php echo $lang['add-showinmenu']; ?>?</td>
    <td class='left'><input type="checkbox" name="inMenu" id="inMenu" style="width: 12px;" value="1" /></td>
   </tr>
   <tr>
    <td class="biggerFont left"><?php echo $lang['provider']; ?>:</td>
    <td class='left'>
     <select name='provider' style="width: 70px;">
      <option value=''><?php echo $lang['global-choose']; ?></option>
<?php
	$PRquery = "SELECT id, name FROM providers";
		try
