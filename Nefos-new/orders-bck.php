<?php
	...
	$selectSales = "SELECT saleid, saletime, userid, amount, amountpaid, quantity, units, adminComment, creditBefore, creditAfter, userConfirmed, fulfilled, paymentoption, customer, paid, discount, invoiced, delivered, comments, intcomment, delivereddate FROM sales WHERE userConfirmed = 1 AND cancelled = 0 $timeLimit ORDER by saletime DESC $limitVar";
		try
		{
	...
	// Query to look up sales
	$selectSales = "SELECT saleid, saletime, userid, amount, amountpaid, quantity, units, adminComment, creditBefore, creditAfter, userConfirmed, fulfilled, paymentoption, customer, paid, discount, invoiced, delivered, comments, intcomment, delivereddate FROM sales WHERE userConfirmed = 1 AND cancelled = 0 $timeLimit ORDER by saletime ASC $limitVar";
		try
		{
