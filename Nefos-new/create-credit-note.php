...
<body>
	<div id="page-wrap">
		...
		<div>
			<div id="customer-title">CREDIT NOTE</div>
			<br>
		</div>
...
$_SESSION['successMessage'] = "Credit Note generated successfully!, please click here to <a href='".$invoice_path."' target='_blank'>Download Credit Note</a> Or If you want to undo this invoice click here to <a href='".$undo_link."'>Undo Credit Note</a>";
