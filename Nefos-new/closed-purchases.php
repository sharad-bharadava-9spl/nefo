...
EOD;
	...
	echo "<center><a href='open-purchases.php' class='cta'>{$lang['open-purchases']}</a>";
...
<?php
	echo "</center><br /><br /><h3 class='title2'>{$lang['closed-purchases']}</h3><br />";
...
<h3 class='title'><?php echo $lang['global-flowerscaps']; ?> (g.)</h3>
...
<?php
	...
	$purchase_row =	sprintf("
  	  <tr>
  	   ...
  	   <td class='clickableRow right' href='purchase.php?closed&purchaseid=%d'>%0.0f g</td>
  	   <td class='clickableRow right' href='purchase.php?closed&purchaseid=%d'>%0.0f g</td>
  	   <td class='clickableRow' style='text-align: center' href='purchase.php?closed&purchaseid=%d'>%s</td>
...
?>
<br /><br />
<h3 class='title'><?php echo $lang['global-extractscaps']; ?> (g.)</h3>
