...
// assign permanent customer number to temp customer

function updatePermanentCustomer($customer_number){
	global $pdo2, $pdo;
 	...
 	$selectNumber = "SELECT MAX(number) FROM customers WHERE number LIKE ('1%')";
		...
		$numberRow = $check_number->fetch();
		 ...
		 // update permanent customer number in customer table
		 ...
		 $updateCustomer = "UPDATE customers SET number = '".$permanent_customer_num."' WHERE number = ".$customer_number;
			...
			// Update contacts
			$query = "UPDATE contacts SET customer = '$permanent_customer_num' WHERE customer = '$customer_number'";
			try
			{
			...
			// Update customers
			$query = "UPDATE customers_old SET number = '$permanent_customer_num' WHERE number = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			// Update calls
			$query = "UPDATE calls SET customerNumber = '$permanent_customer_num' WHERE customerNumber = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			// Update feedback
			$query = "UPDATE feedback SET number = '$permanent_customer_num' WHERE number = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			$query = "UPDATE customernotes SET customer = '$permanent_customer_num' WHERE customer = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			$query = "UPDATE customers_tmp SET number = '$permanent_customer_num' WHERE number = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			$query = "UPDATE inactivecomments SET customer = '$permanent_customer_num' WHERE customer = '$customer_number'";
			try
			{
				$result = $pdo2->prepare("$query")->execute();
			}
			...
			// Update master db
			$query = "UPDATE db_access SET customer = '$permanent_customer_num' WHERE customer = '$customer_number'";
			try
			{
