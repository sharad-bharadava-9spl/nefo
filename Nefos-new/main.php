<?php 
	...
	pageStart("Nefos Tool", NULL, $testinput, "pindex", "notSelected", NULL, $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<center>
 ...
 <a href="search.php"><span id="profileCTA"></span><br />SEARCH</a>
