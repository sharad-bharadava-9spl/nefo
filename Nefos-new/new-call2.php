<?php
    ...
    $(document).ready(function() {
	  ...
	  $('#registerForm').validate({
		  ignore:":hidden:not(.call_radio)", //because the radio buttons are hidden, validation ignores them. This way it'll work.
		  rules: {
			  name: {
				  required: true
			  }
 ...
 <div class='boxcontent'>
	<table class='profileTable' style='text-align: left; margin: 0;'>
		 <tr>
		  ...
		  <td><input type="text" name="time_stamp" id="datepicker" value="<?php echo $current_timestamp; ?>" class='defaultinput eightDigit' required /></td>
		 </tr>
		 <tr>
		 	<td></td>
		 	<td>
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Club
     <input type="radio" name="choose_call_type" value="0" required checked>
     <div class="fakebox"></div>
    </label>
   </div>
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Affiliation
     <input type="radio" name="choose_call_type" value="1" required>
     <div class="fakebox"></div>
    </label>
   </div>
   <br />&nbsp;
   ...
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Normal
     <input type="radio" name="call_method" class="call_radio" id="call_method1" value="1" required>
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Skype
     <input type="radio" name="call_method" class="call_radio" id="call_method2" value="2">
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Whatsapp
     <input type="radio" name="call_method" class="call_radio" id="call_method3" value="3">
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signal
     <input type="radio" name="call_method" class="call_radio" id="call_method4" value="4">
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Telegram
     <input type="radio" name="call_method" class="call_radio" id="call_method5" value="5">
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
   <div class="fakeboxholder customradio">	 
    <label class="control">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wickr
     <input type="radio" name="call_method" class="call_radio" id="call_method6" value="6">
     <div class="fakebox"></div>
    </label>
   </div>
   <br />
		 ...
		 <tr>
		  ...
		  <td>
		   <input type="text" name="customer_name" id="cust_name" class='defaultinput eightDigit' value="<?php echo $shortName; ?>" placeholder="Customer Name" required />
		   <input type="text" name="customer_number" id="cust_num" class="fourDigit defaultinput" value="<?php echo $nextMemberNo ?>" placeholder="Customer Number"  required/>
		  
		   <select name="affiliation_val" id="affiliation_drop" class='defaultinput' style="display: none; width: 200px;" required>
	 ...
	 <label class="control">
	  <span id="errorBox2"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add New Contact Details
	  <input type="checkbox" name="check_contact" id="check_contact" value="1" />
	  <div class="fakebox"></div>
	 </label>
	</div>
	<br>
		  	<select name="contact_name" id="select_contact" required="" class='defaultinput' style='width: 200px;'>
...
?>
		  	...
		  	<select name="contact_club" id="club_name" class='defaultinput' required="" style="display: none; width: 200px;" >
		  		<option value="">Select Customer/club</option>
		  	</select>
		  	<input type="text" name="contact_name2" class='defaultinput sixDigit' id="contact_new" style="display: none;" required="" placeholder="Name">
		  	<input type="text" name="customer_contact" class='defaultinput sixDigit' id="contact_num" value="" placeholder="Number" readonly required="">
		  	<input type="email" name="customer_email" class='defaultinput sixDigit' id="contact_email" value="" placeholder="Email" readonly >
		  	<input type="text" name="contact_role" class='defaultinput sixDigit' id="crole" style="display: none;" placeholder="Role">
		  </td>
		 </tr>
		</table>
		<br>
			...
			<table class='profileTable' style='text-align: left; margin: 0;'>
				...
				<tr>
					<td>
					 ...
					 <td> 
					   <input type="number" name="timer[1]" id="clock1" class="twoDigit defaultinput" readonly required="">(Seconds)
			 ...
			 <tr>
			  ...
			  <td><input type="text" name="issue[1]" id="call_issue1" class="issue_text defaultinput eightDigit" placeholder="Enter Issue" required/></td>
			    <input type="hidden" name="issue_id[1]"  id="issue_id1">
			 </tr>
			 <tr>
			  <td><strong>Department</strong></td>
			  <td>
			  	<select name="department[1]" class="department_cls defaultinput" id="dept_name1" required="" style="width: 224px;">
			  	</select>
			  </td>
			 </tr>
			 <tr>
			  ...
			  <td>
			  	<select name="department_cat[1]" class="department_cat defaultinput" id="dept_cat1" required="" style="width: 224px;">
			  		<option value="">Select Category</option>
			  	</select>
			  	
			 </tr>
			 <tr>
			  <td style='vertical-align: top;'><br /><strong>Comment</strong></td>
			  <td><textarea name="comment[1]" class="defaultinput" style="width: 210px; height: 60px;"></textarea></td>
			 </tr>
			 <tr>
			  <td style='vertical-align: top;'><br /><strong>Next Action</strong></td>
			  <td>
				  	<textarea name="next_desc[1]" placeholder="description" class="defaultinput eightDigit" style="width: 210px; height: 60px;"></textarea>
				  	<input type="text" name="deadline[1]" class="deadpicker defaultinput sixDigit" id="deadline1" placeholder="Deadline" style='vertical-align: bottom;'><br>
				  	<input type="text" name="colleague[1]" id="userselect1"  class="multi_users defaultinput eightDigit" placeholder="select users">
				  	<input type="hidden" name="slected_users[1]" id="user_ids1">
				  	<select name="priority[1]" class='defaultinput' style="width: 118px;">
			 ...
			 <tr>
			  ...
			  <td>
			  	<select name="task_created[1]" id="ctask1" class="task_change defaultinput" required="" style="width: 224px;">
			  		<option value="">Select Option</option>
			  		<option value="Yes">Yes</option>
			  		<option value="No">No</option>
			  	</select>
			  	<input type="text" name="task_url[1]" class="defaultinput eightDigit" id="task_url1" placeholder="Enter URL"  style="display: none;" required="">
			  </td>
			 </tr>
			</table>
		</div>
	 ...
	 <center>
		   	<div class='fakeboxholder'>	
	 <label class="control">
	  <span id="errorBox2"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add inactivity comment as well?
	  <input type="checkbox" name="addinactivity" id="addinactivity" value="1" />
	  <div class="fakebox"></div>
	 </label>
	</div>
	 ...
	 <br />
	<button class='oneClick cta1' name='save_call' type="submit"><?php echo $lang['global-savechanges']; ?></button>
