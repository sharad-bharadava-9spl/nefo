...
// Did this page re-submit with a form? If so, check & store details
	if (isset($_POST['id'])) {
		...
		// Query to update user - 28 arguments
		 $updateUser = "UPDATE departments SET name = '$dept_name'  WHERE id = $id"; 
		try
		{
		...
		// On success: redirect.
		$_SESSION['successMessage'] = "Department updated succesfully!";
...
EOD;
	pageStart("Edit Department", NULL, $validationScript, "pprofile", NULL, "Edit Department", $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
	$id = $_GET['id'];
	// Query to look up calls
	$selectUsers = "SELECT * FROM  departments WHERE id = $id";
	try
	{
		...
		<div class="overview">
		    ...
		    <table class="profileTable" style="text-align: left; margin: 0;">
			     <tr>
					  ...
					  <td><input type="text" name="dept_name" value="<?php echo $name; ?>" required=""></td>
				 </tr>
		    </table>
		    <br />
