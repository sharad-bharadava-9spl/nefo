<?php
	...
	$selectSales = "SELECT saleid, saletime, userid, amount, amountpaid, quantity, units, adminComment, creditBefore, creditAfter, userConfirmed, fulfilled, paymentoption, customer, paid, discount, invoiced, delivered, comments, intcomment FROM sales WHERE userConfirmed = 1 AND cancelled = 1 $timeLimit ORDER by saletime DESC $limitVar";
		try
		{
	...
	// Query to look up sales
	$selectSales = "SELECT saleid, saletime, userid, amount, amountpaid, quantity, units, adminComment, creditBefore, creditAfter, userConfirmed, fulfilled, paymentoption, customer, paid, discount, invoiced, delivered, comments, intcomment FROM sales WHERE userConfirmed = 1 AND cancelled = 1 $timeLimit ORDER by saletime ASC $limitVar";
		try
		{
...
EOD;
	pageStart("Cancelled orders", NULL, $deleteSaleScript, "psales", "sales admin", "CANCELLED ORDERS", $_SESSION['successMessage'], $_SESSION['errorMessage']);
