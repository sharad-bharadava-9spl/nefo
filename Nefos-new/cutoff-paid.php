...
<a href='add-cutoff-comment.php?client=$customer&period=$period&invno=$invno' class='addComment'><img src='images/plus-new.png' width='25' style='margin-bottom: -7px;' />&nbsp;&nbsp;&nbsp;Add comment</a><br /><br /><br />
$comments
...
EOD;
		...
		if ($lastComment == '01-01-1970') {
			...
			$tablerow .= "<tr><td><a href='customer.php?user_id=$customerID'>$customer</a></td><td><a href='customer.php?user_id=$customerID'>$shortName</a></td><td class='right'>$totAmount &euro;</td><td>$warningText</td><td class='centered' style='padding: 0;'><a href='uTil/pl.php?customer=$customerID'>$pl</a></td><td>$invno</td><td>$invdate</td><td>$age</td><td class='right'>$amount &euro;</td><td>$promise</td><td>$cutoffdate</td><td class='noExl'>$lastComment</td><td class='centered noExl'>$commentShow</td></tr>";
...
EOD;
	...
	pageStart("Cutoff dashboard - settled debt", NULL, $validationScript, "pmembership", NULL, "Cutoff dashboard - settled debt", $_SESSION['successMessage'], $_SESSION['errorMessage']);
	
?>

<center>
<a href='cutoff.php' class='cta1'>Open debt</a>
<a href='cutoff-paid-202009.php' class='cta1'>Sep 2020</a>
</center>
<div id='mainbox-new-club' style='width: initial;'>
 <div id='mainboxheader'>
  <center>
   Cutoff dashboard - settled debt
  </center>
 </div>
 <div class='boxcontent'>
  <center>
  This report shows only clubs who had 1 or more unpaid SW invoices as of the 27th of August - which have since been paid.<br /><br />
