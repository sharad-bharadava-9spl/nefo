...
?>
	...
	<center><a href='invoice-section.php' class='cta1'>Invoice Section</a></center>
	 ...
	 <table class='default' id='mainTable'>
	  <thead>	
	   <tr style='cursor: pointer;'>
	   	<th class='centered'>Business Type</th>
	   	<th class='centered'>Invoice Number</th>
	   	<th class='centered'>Region</th>
	   	<th class='centered'>Country</th>
	   	<th class='centered'>Customer Number</th>
	   	<th class='centered'>Customer</th>
	   	<th class='centered'>Invoice Date</th>
	   	...
	   	<th class='centered'># of items</th>
	   	<th class='centered'>Base Amount</th>
	   	<th class='centered'>Discount</th>
	   	<th class='centered'>IVA</th>
	   	<th class='centered'>Credit card fee</th>
	   	<th class='centered'>Total Amount</th>
	   	<th class='centered'>Description</th>
	   	<th class='centered'>Status</th>
	   	<th class='centered'>Payment No.</th>
	   	<th class='centered'>Payment Type</th>
	   	<th class='centered'>Bank Id</th>
	   	<th class='centered'>Settled date</th>
	   	<th class='centered'>Bank lodgment date</th>
	   	<th class='centered'>Amount settled</th>
	   	<th class='centered'>Delta</th>
...
<?php
		...
		if (isset($_GET['customer'])) {
			...
			$query = "SELECT * from invoices WHERE DATE(invdate) > '2019-12-31' AND customer = '{$_GET['customer']}' ORDER BY invdate DESC LIMIT $offset, $resultLimit";

			$queryTotal = ("SELECT * from invoices WHERE DATE(invdate) > '2019-12-31' AND customer = '{$_GET['customer']}' ORDER BY invdate DESC");
			
		} else {
			$query = "SELECT * from invoices WHERE DATE(invdate) > '2019-12-31' AND deleteFlag =0 ORDER BY invdate DESC LIMIT $offset, $resultLimit";

			$queryTotal = ("SELECT * from invoices WHERE DATE(invdate) > '2019-12-31' AND deleteFlag = 0 ORDER BY invdate DESC");
		}
...
?>
   <div  class="actionbox-npr" id = "dialog-3" title = "Invoices">
		...
		<div class='boxcomtemt'>
			...
			<p>Export excel between invoice date time ranges</p><br>
