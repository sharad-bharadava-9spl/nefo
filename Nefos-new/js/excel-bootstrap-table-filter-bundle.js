...
var FilterMenu = function () {
    ...
    FilterMenu.prototype.updateSelectAll = function () {
        ...
        var selectAllVal = this.selectAllCheckbox.checked;
        var sort_icon = $("table").find('th').eq(this.index).find('.dropdown-filter-icon');
            if(selectAllVal ==  true){
                sort_icon.html('<i class="arrow-down"></i>');
            }else{
                sort_icon.html('<img class="filter-icon" src="images/filter.png">');
            } 
    };
...
var FilterCollection = function () {
    ...
    FilterCollection.prototype.bindCheckboxes = function () {
        ...
        this.target.find('.dropdown-filter-menu-item.item').change(function () {
            ...
            var value = $(this).val();
            var th_column = ths[index];
            var sort_icon = $("table").find('th').eq(index).find('.dropdown-filter-icon');
            sort_icon.html('<img class="filter-icon" src="images/filter.png">');
    ...
    FilterCollection.prototype.sort = function(column, order, table, options) {
        var flip = 1;
        var th_column = $(table).find('th').eq(column);
        var sort_icon =  th_column.find('.dropdown-filter-icon');
        //sort_icon.html('<img class="filter-icon" src="images/filter.png">');
        ...
        rows.sort(function(a, b) {
            //sort_icon.html('<i class="arrow-up"></i>');
