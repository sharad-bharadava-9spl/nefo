...
/*
		...
		*/
		...
		//$query = "UPDATE customers_tmp SET approved = 1, approvedby = '{$_SESSION['user_id']}' WHERE id = '$notid'";
		//echo "approved: $query<br />";
/*
		try
		{
			$result = $pdo3->prepare("$query")->execute();
...
/*
		...
		*/
		...
		// Delete contacts from contacts_tmp
	...
	$query = "SELECT * FROM contacts WHERE customer = '$number'";
	try
	{
