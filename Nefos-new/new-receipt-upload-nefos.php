<?php
	...
	if (isset($_GET['expenseid'])) {
		...
		echo "<form action='expenses-nefos.php?expenseid=$expenseid&saveimg' method='post' enctype='multipart/form-data'>";
		
	} else if (isset($_GET['closeday'])) {
		
		echo "<form action='new-expense-1-nefos.php?closeday=true' method='post' enctype='multipart/form-data'>";
		
	} else if (isset($_GET['closeshift'])) {
		
		echo "<form action='new-expense-1-nefos.php?closeshift=true' method='post' enctype='multipart/form-data'>";
		
	} else if (isset($_GET['closeshiftandday'])) {
		
		echo "<form action='new-expense-1-nefos.php?closeshiftandday=true' method='post' enctype='multipart/form-data'>";
		
	} else {
		
		echo "<form action='new-expense-1-nefos.php' method='post' enctype='multipart/form-data'>";
