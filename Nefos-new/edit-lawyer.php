<?php
	...
	if (isset($_POST['name'])) {
		...
		$updateUser = "UPDATE lawyers SET name = '$name', telephone = '$telephone', email = '$email', street = '$street', streetnumber = '$streetnumber', flat = '$flat', postcode = '$postcode', city = '$city', state = '$state', country = '$country' WHERE id = $id";
		try
		{
		...
		// On success: redirect.
		$_SESSION['successMessage'] = "Lawyer updated succesfully!";
...
EOD;
	...
	$selectUsers = "SELECT name, telephone, email, street, streetnumber, flat, postcode, state, city, country FROM lawyers WHERE id = $id";
	try
	{
	...
	pageStart("Edit lawyer", NULL, $validationScript, "pprofile", NULL, "Edit lawyer", $_SESSION['successMessage'], $_SESSION['errorMessage']);
