<?php
	...
	if (isset($_POST['save_video'])) {
		...
		if(empty($tag) || $tag == ''){
		 ...
		 $insertVideo = sprintf("INSERT INTO help_videos (video_title_en, video_title_es, video_title_ca, video_title_fr, video_title_nl, video_title_it, video_status, tags, video_path_en, video_path_es,  video_path_ca,  video_path_fr,  video_path_nl,  video_path_it, preview_path, video_duration_en, video_duration_es, video_duration_ca, video_duration_fr, video_duration_nl, video_duration_it, created_at) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
		...
		try
		{
			$result = $pdo3->prepare("$insertVideo")->execute();
		}
