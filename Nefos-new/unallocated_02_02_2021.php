<?php
	...
	$query = "SELECT invno, invdate, customer, action, cutoffdate, promise, paid, amount FROM invoices WHERE paid = '' AND justificante <> '' AND verified = 1 ORDER BY customer ASC";
	try
	{
