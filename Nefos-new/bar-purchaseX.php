...
?>
 ...
 <div class='infobox fullwidth'>
  ...
  <table>
   <tr>
    <td><?php echo $lang['global-stock']; ?>:</td>
    <td class="bigNumber right"><?php echo number_format($estStock,2); ?> u</td>
   </tr>
   <tr>
    <td><?php echo $lang['pur-displayjar']; ?>:</td>
...
<?php 
	...
	if (isset($_GET['summary'])) {
		...
		// Query to look up movements
		$selectMovements = "SELECT movementid, movementtime, type, purchaseid, quantity, movementTypeid, comment FROM b_productmovements WHERE purchaseid = $purchaseid ORDER by movementtime ASC";
