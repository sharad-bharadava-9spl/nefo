...
<center><strong style='font-size: 20px;'>CLIENTS</strong></center><br />
...
?>
	 ...
	 <br /><br /><br />
<center><strong style='font-size: 20px;'>CONTACTS</strong></center><br />
...
<form id="registerForm" action="" method="POST">
  <div class="mainbox2">
   <div class='mainboxheader'>
    <img src="images/magglass-new.png" style='margin-bottom: -1px; margin-right: 5px;' /> Customer & Contact search
   </div>
   <div class='mainboxcontent'>
 

  <input type="text" name="searchfield" class='defaultinput' placeholder="" autofocus /><br /><br /><br />  
  
 </div>
 </div>
  <button type="submit" class='cta1'>Buscar</button>
</form>
