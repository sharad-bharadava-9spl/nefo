<?php
	...
	if (isset($_GET['reopen'])) {
		...
		echo <<<EOD
<a href="uTil/bar-reopen-stock-item.php?purchaseid=$purchaseid" class="cta">{$lang['pur-reopen']}</a> <a href="new-stock-item.php" class="cta">{$lang['newpurchase']}</a>
EOD;
...
function delete_purchase(purchaseid) {
	if (confirm("{$lang['confirm-deletepurchase']}")) {
				window.location = "uTil/bar-delete-stock-item.php?purchaseid=" + purchaseid;
				}
}
EOD;
...
<div id='productoverview'>
  <a href='bar-change-product-image.php?productid=<?php echo $productid; ?>&purchaseid=<?php echo $purchaseid; ?>&purchase'><img src='images/bar-products/<?php echo $productid . "." . $photoExt; ?>' height='70' style='display: inline; vertical-align: middle;' /></a>
...
<div id="ctawrap">
<a href="bar-open-stock.php" class="cta"><span class="ctatext">&laquo; Open stock</span></a>
<a href="bar-edit-stock-item.php?purchaseid=<?php echo $purchaseid;?>" class="cta"><span class="ctatext"><?php echo $lang['global-edit']; ?></span></a>
<?php
	if ($closedAt == NULL) {
		echo "<a href='bar-add-or-remove.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-addremove']}</span></a>";
		echo "<a href='bar-close-stock-item-2.php?purchaseid=$purchaseid' class='cta'><span class='ctatext'>{$lang['pur-close']}</span></a>";
	} else {
