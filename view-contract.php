...
<br />
<center>
	<a class='cta1' href='sign.php?domain=<?php echo $domain; ?>' ><?php echo $lang['sign-contract'] ?></a>
	<a class='cta1' href='sign-index.php?domain=<?php echo $domain; ?>' style="background-color: red;"><?php echo $lang['reject'] ?></a>
</center>
<?php displayFooter();
