...
<?php if ($_SESSION['domain'] != 'umamis' && $_SESSION['domain'] != 'dankgrass2' && $_SESSION['domain'] != 'thebulldog' && $_SESSION['domain'] != 'atlas2') { ?>
         <a href="#" id="openCOnfirm" style='margin: 0 0 -5px 8px;'/><img src="images/excel-new.png" /></a>
<?php } ?>
...
<?php } ?>
	    ...
	    <th><?php echo $lang['member-nationality']; ?></th>
...
<script type="text/javascript">
	...
	$("#fullList").click(function(){
	    ...
	    var url = "members-full-report.php?sort="+sort+"&order="+order+"&count=0&totalCount=0"; 
	 ...
	 $("#currentList").click(function(){
	    ...
	    $( "#dialog-3" ).dialog( "close" );
	    	...
	    	var sort = "<?php echo $_GET['sort'] ?>";
		    var order = "<?php echo $_GET['order'] ?>";
	   		window.location.href = "members-current-report.php?pageno="+pageNo+"&sort="+sort+"&order="+order;
