<?php
	...
	pageStart("DNI / " . $lang['member-passport'], NULL, NULL, "pprofile", NULL, $lang['member-newmembercaps'] . " - " . $lang['dni-front'], $_SESSION['successMessage'], $_SESSION['errorMessage']);

?>

<form action="register-dni-upload-2.php" method="post" enctype="multipart/form-data">
