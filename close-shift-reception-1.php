...
EOD;
	...
	pageStart($lang['close-shift'], NULL, $validationScript, "pcloseday", "step2 dev-align-center", $lang['closeday-rec-two'], $_SESSION['successMessage'], $_SESSION['errorMessage']);
...
<form onsubmit='oneClick.disabled = true; return true;' id="registerForm" action="close-shift-reception-2.php" method="POST">
...
<br /><br />
<div class="actionbox-np2">
  <div class="mainboxheader"><?php echo $lang['till-cash']; ?> <a href="#" class="cta2" id="aboveValues" style="width: 220px; margin-top: -1px;"><?php echo $lang['use-above-values']; ?></a></div>
 <br /><br />
  <div class="boxcontent">
...
<br /><br />
<div class="actionbox-np2">
<div class="mainboxheader"><?php echo $lang['summary']; ?>  <button class='oneClick cta1' name='oneClick' type="submit"><?php echo $lang['closeday-calculate']; ?></button></div>
<div class="boxcontent">
<table class="purchasetable">
 <tr>
