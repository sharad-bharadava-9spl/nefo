<?php
	...
	if ($_POST['plan'] == 'chosen') {
		...
		if ($usergroup2 == 0) {
			...
			$packageName = 'Business package - 1 year (FREE)';
			$packagePrice = 710;
		}
...
echo "<center><div class='actionbox-np2'><div class='boxcontent'><div class='mainboxheader'>$first_name $last_name</div></div><div class='clearfloat'></div><br />";
...
<form id="registerForm" action="" method="POST" onsubmit="return testInput()">
  ...
  <select name="usergroup2" id="usergroup2" class='defaultinput'>
...
?>
 ...
 <!--  <input type='checkbox' id='free' name='free' value='1' style='width: 15px;' />
  <label for='free'>Free membership?</label> -->
  ...
  <br /><br />
 <button class='cta1' type="submit">Approve member</button>
